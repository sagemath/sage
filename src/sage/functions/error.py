...
class Function_erf(BuiltinFunction):
    ...
    We can evaluate numerically::
        ...
        erf(2)
        sage: erf(2).n()                                                                # optional - sage.symbolic
        0.995322265018953
        sage: erf(2).n(100)                                                             # optional - sage.symbolic
    ...
    Basic symbolic properties are handled by Sage and Maxima::
        ...
        sage: diff(erf(x),x)                                                            # optional - sage.symbolic
        2*e^(-x^2)/sqrt(pi)
        sage: integrate(erf(x),x)                                                       # optional - sage.symbolic
    ...
    Check limits::
        ...
        sage: limit(erf(x), x=0)                                                        # optional - sage.symbolic
        0
        sage: limit(erf(x), x=infinity)                                                 # optional - sage.symbolic
        1

     Check that it's odd::

         sage: erf(1.0)                                                                 # optional - sage.symbolic
         0.842700792949715
         sage: erf(-1.0)                                                                # optional - sage.symbolic
         -0.842700792949715
    ...
    Check against other implementations and against the definition::
        ...
        sage: erf(3).n()                                                                # optional - sage.symbolic
        0.999977909503001
        sage: maxima.erf(3).n()                                                         # optional - sage.symbolic
        0.999977909503001
        sage: 1 - pari(3).erfc()                                                        # optional - sage.libs.pari sage.symbolic
        0.999977909503001
        sage: RR(3).erf()
        0.999977909503001
        sage: (integrate(exp(-x**2), (x,0,3))*2/sqrt(pi)).n()                           # optional - sage.symbolic
        0.999977909503001

    :trac:`9044`::

        sage: N(erf(sqrt(2)),200)                                                       # optional - sage.symbolic
        0.95449973610364158559943472566693312505644755259664313203267

    :trac:`11626`::

        sage: n(erf(2),100)                                                             # optional - sage.symbolic
        0.99532226501895273416206925637
        sage: erf(2).n(100)                                                             # optional - sage.symbolic
        0.99532226501895273416206925637
    ...
    Ensure conversion from maxima elements works::
        ...
        sage: merf = maxima(erf(x)).sage().operator()                                   # optional - sage.symbolic
        sage: merf.parent() == erf.parent()                                             # optional - sage.symbolic
        True

    Make sure we can dump and load it::

        sage: loads(dumps(erf(2)))                                                      # optional - sage.symbolic
        erf(2)
    ...
    Special-case 0 for immediate evaluation::
        ...
        sage: erf(0)
        0
        sage: solve(erf(x)==0, x)                                                       # optional - sage.symbolic
        [x == 0]

    Make sure that we can hold::

        sage: erf(0, hold=True)                                                         # optional - sage.symbolic
        erf(0)
        sage: simplify(erf(0, hold=True))                                               # optional - sage.symbolic
        0
    ...
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: maxima(erf(2))                                                        # optional - sage.symbolic
            erf(2)
            sage: erf(2)._sympy_()                                                      # optional - sympy sage.symbolic
            erf(2)
        """
    ...
    def _eval_(self, x):
        ...
        Input is not an expression but is exact::
            ...
            sage: erf(0)                                                                # optional - sage.symbolic
            0
            sage: erf(1)                                                                # optional - sage.symbolic
            erf(1)
            sage: erf(oo)                                                               # optional - sage.symbolic
            1
            sage: erf(SR(-oo))                                                          # optional - sage.symbolic
            -1
            sage: erf(unsigned_infinity)                                                # optional - sage.symbolic
            Infinity
        ...
        Input is an expression but not a trivial zero::
            ...
            sage: erf(x)                                                                # optional - sage.symbolic
            erf(x)

        Input is an expression which is trivially zero::

            sage: erf(SR(0))                                                            # optional - sage.symbolic
            0
        """
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        EXAMPLES::
            ...
            sage: erf(2).n()                                                            # optional - sage.symbolic
            0.995322265018953
            sage: erf(2).n(200)                                                         # optional - sage.symbolic
            0.99532226501895273416206925636725292861089179704006007673835
            sage: erf(pi - 1/2*I).n(100)                                                # optional - sage.symbolic
        ...
        Check that PARI/GP through the GP interface gives the same answer::
            ...
            sage: gp.set_real_precision(59)  # random                                   # optional - sage.libs.pari
            38
            sage: print(gp.eval("1 - erfc(1)")); print(erf(1).n(200))                   # optional - sage.libs.pari
        ...
        :trac:`13193`::
            ...
            sage: erf(3.0*I)                                                            # optional - sage.symbolic
            1629.99462260157*I
            sage: erf(33.0*I)                                                           # optional - sage.symbolic
            1.51286977510409e471*I

        Check that real ball evaluation is fixed :trac:`28061`::

            sage: RealBallField(128)(erf(5)) # abs tol 1e-38                            # optional - sage.symbolic
    ...
    def _derivative_(self, x, diff_param=None):
        ...
        EXAMPLES::
            ...
            sage: erf(x).diff(x)                                                        # optional - sage.symbolic
            2*e^(-x^2)/sqrt(pi)
        ...
        Check if :trac:`8568` is fixed::
            ...
            sage: var('c,x')                                                            # optional - sage.symbolic
            (c, x)
            sage: derivative(erf(c*x),x)                                                # optional - sage.symbolic
            2*c*e^(-c^2*x^2)/sqrt(pi)
            sage: erf(c*x).diff(x)._maxima_init_()                                      # optional - sage.symbolic
...
class Function_erfi(BuiltinFunction):
    ...
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: maxima(erfi(2))                                                       # optional - sage.symbolic
            erfi(2)
            sage: erfi(2)._sympy_()                                                     # optional - sympy sage.symbolic
            erfi(2)
        """
    ...
    def _eval_(self, x):
        ...
        EXAMPLES::
            ...
            sage: erfi(0)                                                               # optional - sage.symbolic
            0
            sage: erfi(SR(0))                                                           # optional - sage.symbolic
            0
            sage: erfi(oo)                                                              # optional - sage.symbolic
            Infinity
            sage: erfi(SR(-oo))                                                         # optional - sage.symbolic
            Infinity
        """
        if isinstance(x, Expression):
            if x.is_trivial_zero():
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        EXAMPLES::
            ...
            sage: erfi(2.)
            18.5648024145756
            sage: erfi(2).n(100)                                                        # optional - sage.symbolic
            18.564802414575552598704291913
            sage: erfi(-2*I).n(100)                                                     # optional - sage.symbolic
    ...
    def _derivative_(self, x, diff_param=None):
        ...
        EXAMPLES::
            ...
            sage: erfi(x).diff(x)                                                       # optional - sage.symbolic
            2*e^(x^2)/sqrt(pi)
...
class Function_erfc(BuiltinFunction):
    ...
    EXAMPLES::
        ...
        sage: erfc(6)                                                                   # optional - sage.symbolic
        erfc(6)
        sage: erfc(6).n()                                                               # optional - sage.symbolic
    ...
    Check that :trac:`25991` is fixed::
            ...
            sage: erfc(x)._fricas_()                                            # optional - fricas sage.symbolic
            - erf(x) + 1
    ...
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: maxima(erfc(2))                                                       # optional - sage.symbolic
            erfc(2)
            sage: erfc(2)._sympy_()                                                     # optional - sympy sage.symbolic
            erfc(2)
        """
    ...
    def _eval_(self, x):
        ...
        EXAMPLES::
            ...
            sage: erfc(0)                                                               # optional - sage.symbolic
            1
            sage: erfc(SR(0))                                                           # optional - sage.symbolic
            1
            sage: erfc(oo)                                                              # optional - sage.symbolic
            0
            sage: erfc(SR(-oo))                                                         # optional - sage.symbolic
            2
        """
        if isinstance(x, Expression):
            if x.is_trivial_zero():
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        EXAMPLES::
            ...
            sage: erfc(4).n()                                                           # optional - sage.symbolic
            1.54172579002800e-8
            sage: erfc(4).n(100)                                                        # optional - sage.symbolic
            1.5417257900280018852159673487e-8
            sage: erfc(4*I).n(100)                                                      # optional - sage.symbolic
    ...
    def _derivative_(self, x, diff_param=None):
        ...
        EXAMPLES::
            ...
            sage: erfc(x).diff(x)                                                       # optional - sage.symbolic
            -2*e^(-x^2)/sqrt(pi)
        """
        return -2*exp(-x**2)/sqrt(pi)
...
class Function_erfinv(BuiltinFunction):
    ...
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: erfinv(2)._sympy_()                                                   # optional - sympy sage.symbolic
            erfinv(2)
            sage: maxima(erfinv(2))                                                     # optional - sage.symbolic
            inverse_erf(2)
        ...
        Check that :trac:`11349` is fixed::
            ...
            sage: _ = var('z,t')                                                        # optional - sage.symbolic
            sage: PDF = exp(-x^2 /2)/sqrt(2*pi)                                         # optional - sage.symbolic
            sage: integralExpr = integrate(PDF,x,z,oo).subs(z==log(t))                  # optional - sage.symbolic
            sage: y = solve(integralExpr==z,t)[0].rhs().subs(z==1/4)                    # optional - sage.symbolic
            sage: y                                                                     # optional - sage.symbolic
            e^(sqrt(2)*erfinv(1/2))
            sage: y.n()                                                                 # optional - sage.symbolic
            1.96303108415826
        """
    ...
    def _eval_(self, x):
        ...
        EXAMPLES::
            ...
            sage: erfinv(0)                                                             # optional - sage.symbolic
            0
            sage: erfinv(SR(0))                                                         # optional - sage.symbolic
            0
            sage: erfinv(1)                                                             # optional - sage.symbolic
            Infinity
        """
        if isinstance(x, Expression):
            if x.is_trivial_zero():
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        EXAMPLES::
            ...
            sage: erfinv(0.2)
            0.179143454621292
            sage: erfinv(1/5).n(100)                                                    # optional - sage.symbolic
    ...
    def _derivative_(self, x, diff_param=None):
        ...
        EXAMPLES::
            ...
            sage: erfinv(x).diff(x)                                                     # optional - sage.symbolic
...
class Function_Fresnel_sin(BuiltinFunction):
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: fresnel_sin(0)                                                        # optional - sage.symbolic
            0
            sage: fresnel_sin(x).subs(x==0)                                             # optional - sage.symbolic
            0
            sage: x = var('x')                                                          # optional - sage.symbolic
            sage: fresnel_sin(1).n(100)                                                 # optional - sage.symbolic
            0.43825914739035476607675669662
            sage: fresnel_sin(x)._sympy_()                                              # optional - sympy sage.symbolic
            fresnels(x)
        """
    ...
    def _eval_(self, x):
        ...
        EXAMPLES::
            ...
            sage: fresnel_sin(pi)                                                       # optional - sage.symbolic
            fresnel_sin(pi)
            sage: fresnel_sin(oo)
            1/2
            sage: fresnel_sin(-oo)
            -1/2
            sage: fresnel_sin(I*oo)                                                     # optional - sage.symbolic
            -1/2*I
            sage: fresnel_sin(-I*oo)                                                    # optional - sage.symbolic
            1/2*I
        """
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        EXAMPLES::
            ...
            sage: fresnel_sin(pi)                                                       # optional - sage.symbolic
            fresnel_sin(pi)
            sage: fresnel_sin(pi).n(100)                                                # optional - sage.symbolic
    ...
    def _derivative_(self, x, diff_param=None):
        ...
        EXAMPLES::
            ...
            sage: x = var('x')                                                          # optional - sage.symbolic
            sage: fresnel_sin(x).diff(x)                                                # optional - sage.symbolic
            sin(1/2*pi*x^2)
        """
        return sin(pi*x**2/2)
...
class Function_Fresnel_cos(BuiltinFunction):
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: fresnel_cos(0)                                                        # optional - sage.symbolic
            0
            sage: fresnel_cos(x).subs(x==0)                                             # optional - sage.symbolic
            0
            sage: x = var('x')                                                          # optional - sage.symbolic
            sage: fresnel_cos(1).n(100)                                                 # optional - sage.symbolic
            0.77989340037682282947420641365
            sage: fresnel_cos(x)._sympy_()                                              # optional - sympy sage.symbolic
            fresnelc(x)
        """
    ...
    def _eval_(self, x):
        ...
        EXAMPLES::
            ...
            sage: fresnel_cos(pi)                                                       # optional - sage.symbolic
            fresnel_cos(pi)
            sage: fresnel_cos(oo)
            1/2
            sage: fresnel_cos(-oo)
            -1/2
            sage: fresnel_cos(I*oo)                                                     # optional - sage.symbolic
            1/2*I
            sage: fresnel_cos(-I*oo)                                                    # optional - sage.symbolic
            -1/2*I
        """
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        EXAMPLES::
            ...
            sage: fresnel_cos(pi)                                                       # optional - sage.symbolic
            fresnel_cos(pi)
            sage: fresnel_cos(pi).n(100)                                                # optional - sage.symbolic
    ...
    def _derivative_(self, x, diff_param=None):
        ...
        EXAMPLES::
            ...
            sage: x = var('x')                                                          # optional - sage.symbolic
            sage: fresnel_cos(x).diff(x)                                                # optional - sage.symbolic
            cos(1/2*pi*x^2)
        """
        return cos(pi*x**2/2)
