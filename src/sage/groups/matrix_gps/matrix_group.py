...
- Sebastian Oehms (2018-07): Add
  :meth:`~sage.groups.matrix_gps.matrix_group.MatrixGroup_base.subgroup`
  and ``ambient`` see
  :issue:`25894`
"""
...
class MatrixGroup_base(Group):
    ...
    def subgroup(self, generators, check=True):
        ...
        :class:`~sage.groups.matrix_gps.finitely_generated_gap.FinitelyGeneratedMatrixGroup_gap`
