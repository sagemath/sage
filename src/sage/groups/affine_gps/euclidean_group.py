...
class EuclideanGroup(AffineGroup):
    ...
    Some additional ways to create Euclidean groups::
        ...
        sage: G = EuclideanGroup(A); G                                                              # optional - sage.libs.pari
        Euclidean Group of degree 2 over Finite Field in a of size 2^2
        sage: G is EuclideanGroup(2,4) # shorthand                                                  # optional - sage.libs.pari
        True
    ...
    TESTS::
        ...
        True
        sage: G = EuclideanGroup(2, GF(5)); G                                                       # optional - sage.libs.pari
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: G = EuclideanGroup(6, GF(5))                                                      # optional - sage.libs.pari
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: EuclideanGroup(6, GF(5))                                                          # optional - sage.libs.pari
    ...
    def random_element(self):
        ...
        EXAMPLES::
            ...
            sage: G = EuclideanGroup(4, GF(3))                                                      # optional - sage.libs.pari
        ...
        TESTS::
            ...
            sage: G.random_element().A().is_unitary()                                               # optional - sage.libs.pari
            True
        """
        while True:
