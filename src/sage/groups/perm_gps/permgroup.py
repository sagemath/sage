...
class PermutationGroup_generic(FiniteGroup):
    ...
    def iteration(self, algorithm="SGS"):
        ...
        if algorithm in ["BFS", "DFS"]:
            ...
            def successors(g):
                return (g._mul_(h) for h in gens)

            enumeration = "breadth" if algorithm[0] == "B" else "depth"
    ...
    def strong_generating_system(self, base_of_group=None, implementation="sage"):
        ...
        OUTPUT: a list of lists of permutations from the group, which forms a
    ...
    def semidirect_product(self, N, mapping, check=True):
        ...
        center and 9 conjugacy classes. ::
            ...
            sage: len(list(S1.conjugacy_classes_representatives()))
            9
    ...
    def character(self, values):
        ...
        EXAMPLES::
            ...
            sage: G = AlternatingGroup(4)
            sage: n = len(list(G.conjugacy_classes_representatives()))
    ...
    def conjugacy_classes_representatives(self):
        """
        Iterate over representatives of conjugacy classes in
        ...
        EXAMPLES::
            ...
            sage: G = PermutationGroup([[(1,2),(3,4)], [(1,2,3,4)]])
            sage: cl = list(G.conjugacy_classes_representatives()); cl
        ...
        ::
            ...
            sage: G = SymmetricGroup(5)
            sage: list(G.conjugacy_classes_representatives())                                 # needs sage.combinat
            [(), (1,2), (1,2)(3,4), (1,2,3), (1,2,3)(4,5), (1,2,3,4), (1,2,3,4,5)]

        ::

            sage: S = SymmetricGroup(['a','b','c'])
            sage: list(S.conjugacy_classes_representatives())                                 # needs sage.combinat
            [(), ('a','b'), ('a','b','c')]
        ...
        - David Joyner and William Stein (2006-01-04)
        """
        it = libgap.Iterator(self._libgap_().ConjugacyClasses())
        while not it.IsDoneIterator().sage():
            cc = it.NextIterator()
            yield self(cc.Representative(), check=False)
    ...
    def conjugacy_classes_subgroups(self):
        ...
        EXAMPLES::
            ...
            sage: G = PermutationGroup([[(1,2),(3,4)], [(1,2,3,4)]])
            sage: cl = G.conjugacy_classes_subgroups(); list(cl)
            [Subgroup generated by [()] of
    ...
    def subgroups(self):
        r"""
        Iterate over all the subgroups of ``self``.
        ...
        while not it.IsDoneIterator().sage():
            sub = it.NextIterator()
            for h in sub.Elements():
                yield self.subgroup(gap_group=h)
