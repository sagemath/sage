...
class PermutationGroup_generic(FiniteGroup):
    ...
    def is_GroupByGenerators(self, generators):
        ...
        group_made_by_generators = set(PermutationGroup_generic(gap_group=libgap.GroupByGenerators(generators)).list())
