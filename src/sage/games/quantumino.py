...
viewer::
    ...
    sage: show_pentaminos()                                                             # optional - sage.plot
    Graphics3d Object
...
To solve the puzzle where the pentamino numbered 12 is put aside::
    ...
    sage: s.show3d()                                      # long time (<1s)             # optional - sage.plot
    Graphics3d Object

To remove the frame::

    sage: s.show3d().show(frame=False)                    # long time (<1s)             # optional - sage.plot
...
To get the solution inside other boxes::
    ...
    sage: s.show3d()                                                # not tested (<1s)  # optional - sage.plot
