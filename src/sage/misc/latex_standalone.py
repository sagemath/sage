...
Adding a border in the options avoids cropping the vertices of a graph::
    ...
    sage: t = TikzPicture(s, standalone_config=["border=4mm"],  # optional - latex sage.graphs
...
class TikzPicture(Standalone):
    ...
    def from_graph(cls, graph, merge_multiedges=True,
        ...
        :trac:`22070`)::
            ...
            sage: S = FiniteSetMaps(5)                                                  # optional - sage.combinat
            sage: I = S((0,1,2,3,4))                                                    # optional - sage.combinat
            sage: a = S((0,1,3,0,0))                                                    # optional - sage.combinat
            sage: b = S((0,2,4,1,0))                                                    # optional - sage.combinat
            sage: roots = [I]                                                           # optional - sage.combinat
            sage: succ = lambda v: [v*a,v*b,a*v,b*v]                                    # optional - sage.combinat
            sage: R = RecursivelyEnumeratedSet(roots, succ)                             # optional - sage.combinat
            sage: G = R.to_digraph()                        # optional - sage.graphs    # optional - sage.combinat
            sage: G                                         # optional - sage.graphs    # optional - sage.combinat
            Looped multi-digraph on 27 vertices
            sage: C = G.strongly_connected_components()     # optional - sage.graphs    # optional - sage.combinat
            sage: tikz = TikzPicture.from_graph(G,          # optional - dot2tex graphviz sage.combinat sage.graphs
