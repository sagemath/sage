...
Sage example in ./integration.tex, line 785::
  ...
  sage: sage.libs.mpmath.mp.prec = 53
  sage: sage.libs.mpmath.quad(lambda x: sage.libs.mpmath.sin(sage.libs.mpmath.sin(x)), [0, 1])
  mpf('0.43060610312069059')

Sage example in ./integration.tex, line 795::

  sage: a = RDF(pi); b = sage.libs.mpmath.mpf(a); b
...
Sage example in ./integration.tex, line 824::
  ...
  sage: sage.libs.mpmath.mp.prec = 113
  sage: sage.libs.mpmath.quad(lambda x: sage.libs.mpmath.sin(sage.libs.mpmath.sin(x)), [0, 1])
...
Sage example in ./integration.tex, line 846::
  ...
  sage: f(x) = sin(sin(x))
  sage: sage.libs.mpmath.quad(f, [0, 1])
...
Sage example in ./integration.tex, line 866::
  ...
  sage: sage.libs.mpmath.mp.prec = 100
  sage: sage.libs.mpmath.quadts(lambda x: g(N(x, 100)), [0, 1])
  mpf('0.873912416263035435957979086252')

Sage example in ./integration.tex, line 878::

  sage: sage.libs.mpmath.mp.prec = 170
  sage: sage.libs.mpmath.quadts(lambda x: g(N(x, 190)), [0, 1])
...
Sage example in ./integration.tex, line 892::
  ...
  sage: sage.libs.mpmath.quadts(lambda x: g(N(x, 170)), [0, sage.libs.mpmath.pi / 4, 1])
...
Sage example in ./integration.tex, line 1016::
  ...
  sage: f = lambda y: RDF(sage.libs.mpmath.quad(lambda x: sage.libs.mpmath.exp(y*mpmath.sin(x)), \
                                      [0, sqrt(y)]))
  sage: numerical_integral(f, 0, 1) # abs tol 2e-16
...
Sage example in ./integration.tex, line 1027::
  ...
  sage: sage.libs.mpmath.mp.dps = 60
  sage: f = lambda x, y: sage.libs.mpmath.exp(y*mpmath.sin(x))
  sage: sage.libs.mpmath.quad(f, [0,1], [0,1])
...
Sage example in ./integration.tex, line 1399::
  ...
  sage: import sage.libs.mpmath
  sage: sage.libs.mpmath.mp.prec = 53
  sage: sol = sage.libs.mpmath.odefun(lambda t, y: y, 0, 1)
  sage: sol(1)
...
Sage example in ./integration.tex, line 1436::
  ...
  sage: sage.libs.mpmath.mp.prec = 53
  sage: f = sage.libs.mpmath.odefun(lambda t, y: [-y[1], y[0]], 0, [1, 0])
  sage: f(3)
...
Sage example in ./integration.tex, line 1497::
  ...
  sage: sage.libs.mpmath.mp.prec = 10
  sage: sol = sage.libs.mpmath.odefun(lambda t, y: y, 0, 1)
  sage: sol(1)
  mpf('2.7148')
  sage: sage.libs.mpmath.mp.prec = 100
