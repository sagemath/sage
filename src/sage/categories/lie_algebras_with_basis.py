...
class LieAlgebrasWithBasis(CategoryWithAxiom_over_base_ring):
    ...
    def example(self, gens=None):
        ...
        EXAMPLES::
            ...
            sage: LieAlgebras(QQ).WithBasis().example()                                 # optional - sage.combinat sage.modules
        ...
        Another set of generators can be specified as an optional argument::
            ...
            sage: LieAlgebras(QQ).WithBasis().example(Compositions())                   # optional - sage.combinat sage.modules
            An example of a Lie algebra: the abelian Lie algebra on the
    ...
    class ParentMethods:
        def _basis_key(self, x):
            ...
            TESTS::
                ...
                sage: L = LieAlgebras(QQ).WithBasis().example()                         # optional - sage.combinat sage.modules
                sage: L._basis_key(Partition([3,1]))                                    # optional - sage.combinat sage.modules
                [3, 1]
            """
            return x
        ...
        def bracket_on_basis(self, x, y):
            ...
            EXAMPLES::
                ...
                sage: L = LieAlgebras(QQ).WithBasis().example()                         # optional - sage.combinat sage.modules
                sage: L.bracket_on_basis(Partition([3,1]), Partition([2,2,1,1]))        # optional - sage.combinat sage.modules
                0
            """
    ...
    class ElementMethods:
        def _bracket_(self, y):
            ...
            EXAMPLES::
                ...
                sage: L = LieAlgebras(QQ).WithBasis().example()                         # optional - sage.combinat sage.modules
                sage: G = L.lie_algebra_generators()                                    # optional - sage.combinat sage.modules
                sage: x = G[Partition([4,3,3,1])]                                       # optional - sage.combinat sage.modules
                sage: y = G[Partition([6,1])]                                           # optional - sage.combinat sage.modules
