    ...
    class ParentMethods:
        ...
        def is_zero(self) -> bool:
            ...
            EXAMPLES::
                ...
                sage: R.quo(77).is_zero()                                                                               # optional - sage.libs.pari
                True
                sage: R.quo(x^2 + 1).is_zero()                                                                          # optional - sage.libs.pari
                False
            """
        ...
        def characteristic(self):
            ...
            EXAMPLES::
                ...
                0
                sage: GF(19).characteristic()                                                                           # optional - sage.libs.pari
                19
        ...
        def __getitem__(self, arg):
            ...
            We can create Ore polynomial rings::
                ...
                sage: k['x', Frob]                                                                                      # optional - sage.libs.pari
