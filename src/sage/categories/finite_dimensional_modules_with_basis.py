    ...
    class ParentMethods:
        ...
        def _dense_free_module(self, base_ring=None):
            ...
            EXAMPLES::
                ...
                sage: C = CombinatorialFreeModule(QQ['x'], ['a','b','c']); C                                            # optional - sage.modules
                Free module generated by {'a', 'b', 'c'} over
                 Univariate Polynomial Ring in x over Rational Field
                sage: C._dense_free_module()                                                                            # optional - sage.modules
                Ambient free module of rank 3 over the principal ideal domain
                 Univariate Polynomial Ring in x over Rational Field
                sage: C._dense_free_module(QQ['x,y'])                                                                   # optional - sage.modules
        ...
        def invariant_module(self, S, action=operator.mul, action_on_basis=None,
            ...
            of the symmetric group::
                ...
                sage: G = SymmetricGroup(3); G.rename('S3')                     # optional - sage.groups                # optional - sage.modules
                ...
                sage: G.rename(); M.rename()  # reset the names                 # optional - sage.groups                # optional - sage.modules
