    ...
    class ParentMethods:
        ...
        def meet(self, x, y):
            ...
            EXAMPLES::
                ...
                sage: D = LatticePoset((divisors(30), attrcall("divides")))             # optional - sage.combinat sage.graphs sage.modules
                sage: D.meet( D(6), D(15) )                                             # optional - sage.combinat sage.graphs sage.modules
                3
            """
        ...
        def join(self, x, y):
            ...
            EXAMPLES::
                ...
                sage: D.join( D(6), D(10) )                                             # optional - sage.combinat sage.graphs sage.modules
                30
            """
