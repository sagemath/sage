    ...
    class ParentMethods:
        def zeta_function(self, prec=53,
            ...
            EXAMPLES::
                ...
                sage: Z = K.zeta_function(); Z                                      # optional - sage.symbolic          # optional - sage.rings.number_field
                PARI zeta function associated to Number Field in a with defining polynomial x^2 + x - 1
                sage: Z(-1)                                                         # optional - sage.symbolic          # optional - sage.rings.number_field
                0.0333333333333333

                sage: x = polygen(QQ, 'x')
                sage: L.<a, b, c> = NumberField([x^2 - 5, x^2 + 3, x^2 + 1])                                            # optional - sage.rings.number_field
                sage: Z = L.zeta_function()                                         # optional - sage.symbolic          # optional - sage.rings.number_field
                sage: Z(5)                                                          # optional - sage.symbolic          # optional - sage.rings.number_field
                1.00199015670185

            Using the algorithm "pari"::

                sage: K.<a> = NumberField(ZZ['x'].0^2 + ZZ['x'].0 - 1)                                                  # optional - sage.rings.number_field
                sage: Z = K.zeta_function(algorithm="pari")                         # optional - sage.symbolic          # optional - sage.rings.number_field
                sage: Z(-1)                                                         # optional - sage.symbolic          # optional - sage.rings.number_field
                0.0333333333333333

                sage: x = polygen(QQ, 'x')
                sage: L.<a, b, c> = NumberField([x^2 - 5, x^2 + 3, x^2 + 1])                                            # optional - sage.rings.number_field
                sage: Z = L.zeta_function(algorithm="pari")                         # optional - sage.symbolic          # optional - sage.rings.number_field
                sage: Z(5)                                                          # optional - sage.symbolic          # optional - sage.rings.number_field
                1.00199015670185
