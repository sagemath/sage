...
class LieConformalAlgebras(Category_over_base_ring):
    ...
    ``Super``. These functors commute::
        ...
        sage: LieConformalAlgebras(AA).Graded().Super()                                                                 # optional - sage.rings.number_field
        Category of H-graded super Lie conformal algebras over Algebraic Real Field
        sage: LieConformalAlgebras(AA).Graded().Super() is LieConformalAlgebras(AA).Super().Graded()                    # optional - sage.rings.number_field
        True
