    ...
    class ParentMethods:
        ...
        def join_irreducibles(self):
            ...
            EXAMPLES::
                ...
                sage: L.join_irreducibles()                                             # optional - sage.combinat sage.graphs sage.modules
                [1, 2, 4]
        ...
        def join_irreducibles_poset(self):
            ...
            EXAMPLES::
                ...
                sage: L = LatticePoset({0:[1,2,3],1:[4],2:[4],3:[4]})                   # optional - sage.combinat sage.graphs sage.modules
                sage: L.join_irreducibles_poset()                                       # optional - sage.combinat sage.graphs sage.modules
        ...
        def irreducibles_poset(self):
            ...
            EXAMPLES::
                ...
                sage: L = LatticePoset({1: [2, 3, 4], 2: [5, 6], 3: [5],                # optional - sage.combinat sage.graphs sage.modules
                ....:                   4: [6], 5: [9, 7], 6: [9, 8], 7: [10],
                ....:                   8: [10], 9: [10], 10: [11]})
                sage: L_ = L.irreducibles_poset()                                       # optional - sage.combinat sage.graphs sage.modules
                sage: sorted(L_)                                                        # optional - sage.combinat sage.graphs sage.modules
                [2, 3, 4, 7, 8, 9, 10, 11]
                sage: L_.completion_by_cuts().is_isomorphic(L)                          # optional - sage.combinat sage.graphs sage.modules
                True

            TESTS::

                sage: LatticePoset().irreducibles_poset()                               # optional - sage.combinat sage.graphs sage.modules
                Finite poset containing 0 elements
                sage: posets.ChainPoset(1).irreducibles_poset()                         # optional - sage.combinat sage.graphs sage.modules
        ...
        def is_lattice_morphism(self, f, codomain):
            ...
            `b \mapsto 5 \prod_{x\in b} x` is a morphism of lattices::
                ...
                sage: D = LatticePoset((divisors(60), attrcall("divides")))             # optional - sage.combinat sage.graphs sage.modules
                sage: B = LatticePoset((Subsets([2,2,3]), attrcall("issubset")))        # optional - sage.combinat sage.graphs sage.modules
                sage: def f(b): return D(5*prod(b))                                     # optional - sage.combinat sage.graphs sage.modules
                sage: B.is_lattice_morphism(f, D)                                       # optional - sage.combinat sage.graphs sage.modules
                True

            We construct the boolean lattice `B_2`::

                sage: B = posets.BooleanLattice(2)                                      # optional - sage.combinat sage.graphs sage.modules
                sage: B.cover_relations()                                               # optional - sage.combinat sage.graphs sage.modules
                [[0, 1], [0, 2], [1, 3], [2, 3]]
            ...
            numbered respectively `-1` and `3`::
                ...
                sage: L = LatticePoset(G)                                               # optional - sage.combinat sage.graphs sage.modules
                sage: L.cover_relations()                                               # optional - sage.combinat sage.graphs sage.modules
                [[-1, 0], [0, 1], [0, 2], [1, 3], [2, 3], [3, 4]]

                sage: f = {B(0): L(0), B(1): L(1), B(2): L(2), B(3): L(3)}.__getitem__  # optional - sage.combinat sage.graphs sage.modules
                sage: B.is_lattice_morphism(f, L)                                       # optional - sage.combinat sage.graphs sage.modules
                True

                sage: f = {B(0): L(-1),B(1): L(1), B(2): L(2), B(3): L(3)}.__getitem__  # optional - sage.combinat sage.graphs sage.modules
                sage: B.is_lattice_morphism(f, L)                                       # optional - sage.combinat sage.graphs sage.modules
                False

                sage: f = {B(0): L(0), B(1): L(1), B(2): L(2), B(3): L(4)}.__getitem__  # optional - sage.combinat sage.graphs sage.modules
                sage: B.is_lattice_morphism(f, L)                                       # optional - sage.combinat sage.graphs sage.modules
                False
