    ...
    class ParentMethods:
        ...
        def tensor(*parents, **kwargs):
            ...
            a signed tensor product (:trac:`31266`)::
                ...
                sage: M = CombinatorialFreeModule(GF(3), ['s', 't', 'u'])       # optional - sage.libs.pari             # optional - sage.modules
                sage: s = M.basis()['s']                                        # optional - sage.libs.pari             # optional - sage.modules
                sage: tensor([a, s])                                            # optional - sage.libs.pari             # optional - sage.modules
                2*Q_1 Q_3 P(2,1) # B['s']
            """
