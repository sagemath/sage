    ...
    class ParentMethods:
        ...
        def homology(self, n=None):
            ...
            EXAMPLES::
                ...
                sage: C.homology(0)                                                     # needs sage.modules
                Z x Z
            ...
            ::
                ...
                sage: C.homology(0)                                                     # needs sage.combinat sage.modules
                Free module generated by {[1]} over Rational Field
                sage: C.homology(1)                                                     # needs sage.combinat sage.modules
                Free module generated by {} over Rational Field
                sage: C.homology(2)                                                     # needs sage.combinat sage.modules
                Free module generated by {[x], [y]} over Rational Field
                sage: C.homology(3)                                                     # needs sage.combinat sage.modules
                Free module generated by {} over Rational Field
                sage: C.homology(4)                                                     # needs sage.combinat sage.modules
        ...
        def lift_from_homology(self, x):
            ...
            EXAMPLES::
                ...
                sage: C = E3.de_rham_complex()                                          # needs sage.symbolic
                sage: one = C.homology().one()                                          # needs sage.symbolic
                sage: C.lift_from_homology(one)                                         # needs sage.symbolic
        ...
        def reduce_to_homology(self, x, n=None):
            ...
            EXAMPLES::
                ...
                sage: E3 = EuclideanSpace(3)                                            # needs sage.symbolic
                sage: C = E3.de_rham_complex()                                          # needs sage.symbolic
                sage: one = C.one()                                                     # needs sage.symbolic
                sage: C.reduce_to_homology(one)                                         # needs sage.symbolic
                [one]
            """
            try:
                # try coercion
...
class HomologyFunctor(Functor):
    ...
    def _apply_functor_to_morphism(self, f):
        ...
        TESTS::
            ...
            sage: E3 = EuclideanSpace(3)                                                # needs sage.symbolic
            sage: C = E3.de_rham_complex()                                              # needs sage.symbolic
            sage: id = Hom(C, C).identity()                                             # needs sage.symbolic
            sage: H = HomologyFunctor(ChainComplexes(SR))                               # needs sage.symbolic
            sage: id_star = H(id); id_star                                              # needs sage.symbolic
            Generic endomorphism of De Rham cohomology ring on the
             Euclidean space E^3
            sage: one = H(C).one()                                                      # needs sage.symbolic
            sage: id_star(one)                                                          # needs sage.symbolic
            [one]
        """
