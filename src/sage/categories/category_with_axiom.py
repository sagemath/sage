...
from sage.misc.call import call_method, attrcall
...
[Axiom(axiom) for axiom in [
    "Commutative", "Associative", "Inverse", "Unital",
    "NoZeroDivisors", "Division"]]
...
Axiom("Nilpotent")
Axiom("Cocommutative")
Axiom("Supercommutative")
Axiom("Supercocommutative")
Axiom("Stratified")
Axiom("FinitelyGeneratedAsLambdaBracketAlgebra")
Axiom("FinitelyPresented")
