...
class FiniteEnumeratedSets(CategoryWithAxiom):
    ...
    def _call_(self, X):
        ...
        EXAMPLES::
            ...
            sage: FiniteEnumeratedSets()(GF(3))                                                                         # optional - sage.libs.pari
        ...
        class ParentMethods:
            ...
            def last(self):
                ...
                EXAMPLES::
                    ...
                    sage: C = cartesian_product([Zmod(42), Partitions(10), IntegerRange(5)])                            # optional - sage.combinat
            ...
            def rank(self, x):
                ...
                EXAMPLES::
                    ...
                    sage: C = cartesian_product([GF(2), GF(11), GF(7)])                                                 # optional - sage.libs.pari
                    sage: C.rank(C((1,2,5)))                                                                            # optional - sage.libs.pari
                    96
                    sage: C.rank(C((0,0,0)))                                                                            # optional - sage.libs.pari
                    0

                    sage: for c in C: print(C.rank(c))                                                                  # optional - sage.libs.pari
                    0
                    1
                    2
                    3
            ...
            def unrank(self, i):
                ...
                EXAMPLES::
                    ...
                    sage: C = cartesian_product([GF(3), GF(11), GF(7), GF(5)])                                          # optional - sage.libs.pari
                    sage: c = C.unrank(123); c                                                                          # optional - sage.libs.pari
                    (0, 3, 3, 3)
                    sage: C.rank(c)                                                                                     # optional - sage.libs.pari
                    123

                    sage: c = C.unrank(857); c                                                                          # optional - sage.libs.pari
                    (2, 2, 3, 2)
                    sage: C.rank(c)                                                                                     # optional - sage.libs.pari
                    857

                    sage: C.unrank(2500)                                                                                # optional - sage.libs.pari
                    Traceback (most recent call last):
                    ...
