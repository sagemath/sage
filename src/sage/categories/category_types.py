...
class Category_over_base(CategoryWithParameters):
    ...
    EXAMPLES::
        ...
        sage: Algebras(GF(2)).element_class is Algebras(GF(3)).element_class                                            # optional - sage.libs.pari
        True

        sage: C = GF(2).category()                                                                                      # optional - sage.libs.pari
        sage: Algebras(GF(2)).parent_class is Algebras(C).parent_class                                                  # optional - sage.libs.pari
        True
    ...
    def _repr_object_names(self):
        ...
        EXAMPLES::
            ...
            sage: Algebras(GF(2).category())._repr_object_names()                                                       # optional - sage.libs.pari
...
class Category_over_base_ring(Category_over_base):
    def __init__(self, base, name=None):
        ...
        EXAMPLES::
            ...
            sage: C = Algebras(GF(2)); C                                                                                # optional - sage.libs.pari
            Category of algebras over Finite Field of size 2
            sage: TestSuite(C).run()                                                                                    # optional - sage.libs.pari
        """
    ...
    def base_ring(self):
        ...
        EXAMPLES::
            ...
            sage: C = Algebras(GF(2))                                                                                   # optional - sage.libs.pari
            sage: C.base_ring()                                                                                         # optional - sage.libs.pari
    ...
    def _subcategory_hook_(self, C):
        ...
        Case 3: the two bases are parents; then they should coincide::
            ...
            False
            sage: VectorSpaces(GF(2))._subcategory_hook_(Algebras(GF(3))) # base ring in the same category              # optional - sage.libs.pari
            False
