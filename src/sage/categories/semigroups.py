    ...
    class ParentMethods:
        ...
        def cayley_graph(self, side="right", simple=False, elements=None,
            ...
            the elements of length at most 3::
                ...
                sage: G = M.cayley_graph(elements=elements)                                                             # optional - sage.graphs
                sage: G.num_verts(), G.num_edges()                                                                      # optional - sage.graphs
                (85, 84)
                sage: G.show3d(color_by_label=True, edge_size=0.001, vertex_size=0.01)                                  # optional - sage.graphs, sage.plot
