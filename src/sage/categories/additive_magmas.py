        ...
        class ElementMethods:
            def _add_(self, right):
                ...
                EXAMPLES::
                    ...
                    sage: G5 = GF(5); G8 = GF(4, 'x'); GG = G5.cartesian_product(G8)                                    # optional - sage.libs.pari
                    sage: e = GG((G5(1), G8.primitive_element())); e                                                    # optional - sage.libs.pari
                    (1, x)
                    sage: e + e                                                                                         # optional - sage.libs.pari
                    (2, 0)
                    sage: e = groups.misc.AdditiveCyclic(8)                                                             # optional - sage.libs.pari
                    sage: x = e.cartesian_product(e)((e(1), e(2)))                                                      # optional - sage.libs.pari
                    sage: x                                                                                             # optional - sage.libs.pari
                    (1, 2)
                    sage: 4 * x                                                                                         # optional - sage.libs.pari
                    (4, 0)
                """
        ...
        class ElementMethods:
            ...
            def _sub_(left, right):
                ...
                Check that :trac:`18275` is fixed::
                    ...
                    sage: C = GF(5).cartesian_product(GF(5))                                                            # optional - sage.libs.pari
                    sage: C.one() - C.one()                                                                             # optional - sage.libs.pari
                    (0, 0)
                """
                return left + (-right)
                ...
                class ElementMethods:
                    def _neg_(self):
                        ...
                        EXAMPLES::
                           ...
                           sage: x = cartesian_product((GF(7)(2), 17)); x                                               # optional - sage.libs.pari
                           (2, 17)
                           sage: -x                                                                                     # optional - sage.libs.pari
                           (5, -17)
                        ...
                        TESTS::
                           ...
                           sage: x.parent() in AdditiveMagmas().AdditiveUnital().AdditiveInverse().CartesianProducts()  # optional - sage.libs.pari
                           True
                        """
                        return self.parent()._cartesian_product_of_elements(
            ...
            class ParentMethods:
                def zero(self):
                    ...
                    EXAMPLES::
                        ...
                        sage: GF(8, 'x').cartesian_product(GF(5)).zero()                                                # optional - sage.libs.pari
                        (0, 0)
                    """
