...
class SympyConverter(Converter):
    ...
    EXAMPLES::
        ...
        sage: f._sympy_()                                                               # needs sympy
        exp(x**2) - asin(x + pi)/y
        sage: _._sage_()                                                                # needs sympy
        -arcsin(pi + x)/y + e^(x^2)

        sage: sympy.sympify(x) # indirect doctest                                       # needs sympy
        x
    ...
    Make sure we can convert I (:trac:`6424`)::
        ...
        sage: bool(I._sympy_() == I)                                                    # needs sympy
        True
        sage: (x+I)._sympy_()                                                           # needs sympy
        x + I
    ...
    def __init__(self):
        ...
        TESTS::
            ...
            sage: s = SympyConverter()  # indirect doctest                              # needs sympy
            sage: TestSuite(s).run(skip="_test_pickling")                               # needs sympy
        """
    ...
    def pyobject(self, ex, obj):
        ...
        EXAMPLES::
            ...
            sage: s = SympyConverter()                                                  # needs sympy
            sage: f = SR(2)
            sage: s.pyobject(f, f.pyobject())                                           # needs sympy
            2
    ...
    def arithmetic(self, ex, operator):
        ...
        EXAMPLES::
            ...
            sage: s = SympyConverter()                                                  # needs sympy
            sage: f = x + 2
            sage: s.arithmetic(f, f.operator())                                         # needs sympy
            x + 2
        """
        import sympy
    ...
    def composition(self, ex, operator):
        ...
        EXAMPLES::
            ...
            sage: s = SympyConverter()                                                  # needs sympy
            sage: f = sin(2)
            sage: s.composition(f, f.operator())                                        # needs sympy
            sin(2)
            sage: type(_)                                                               # needs sympy
            sin
            sage: f = arcsin(2)
    ...
    def tuple(self, ex):
        ...
        TESTS::
            ...
            sage: from sage.symbolic.expression_conversions import sympy_converter      # needs sympy
            ...
            sage: var('a,b,c,d')
            (a, b, c, d)
            sage: hypergeometric((a,b,),(c,),d)._sympy_()                               # needs sympy
            hyper((a, b), (c,), d)
        """
    ...
    def derivative(self, ex, operator):
        ...
        TESTS::
            ...
            sage: f_sympy = f_sage._sympy_()                                            # needs sympy

            sage: df_sage = f_sage.diff(x, 2, y, 1); df_sage
            diff(f_sage(x, y), x, x, y)
            sage: df_sympy = df_sage._sympy_(); df_sympy                                # needs sympy
            Derivative(f_sage(x, y), (x, 2), y)
            sage: df_sympy == f_sympy.diff(x, 2, y, 1)                                  # needs sympy
            True
        ...
        Check that :trac:`28964` is fixed::
            ...
            sage: f = function('f')
            sage: _ = var('x,t')
            sage: diff(f(x, t), x)._sympy_(), diff(f(x, t), t)._sympy_()                # needs sympy
