...
cdef class SymbolicRing(sage.rings.abc.SymbolicRing):
    ...
    cpdef _coerce_map_from_(self, R):
        ...
        if isinstance(R, type):
            ...
            elif isinstance(R, PolynomialRing_generic) or isinstance(R, MPolynomialRing_base) or isinstance(R, FractionField_generic) or isinstance(R, LaurentPolynomialRing_generic):
                base = R.base_ring()
