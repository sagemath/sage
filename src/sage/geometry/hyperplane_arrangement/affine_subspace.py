...
EXAMPLES::
    ...
    sage: c < b
    False
    sage: A = AffineSubspace([8,38,21,250], VectorSpace(GF(19),4))                      # needs sage.libs.pari
...
class AffineSubspace(SageObject):
    ...
    def intersection(self, other):
        ...
        EXAMPLES::
            ...
            sage: D = AffineSubspace([1,2,3], VectorSpace(GF(5),3))                     # needs sage.libs.pari
            sage: E = AffineSubspace([3,4,5], VectorSpace(GF(5),3))                     # needs sage.libs.pari
            sage: D.intersection(E)                                                     # needs sage.libs.pari
            Affine space p + W where:
              p = (3, 4, 0)
