...
def cutwidth(G, algorithm="exponential", cut_off=0, solver=None, verbose=False,
    ...
    Cutwidth of a graph with one edge (:trac:`32131`)::
        ...
        (1, [0, 1])
        sage: cutwidth(G, algorithm="MILP", solver='GLPK')                              # optional - sage.numerical.mip
        (1, [0, 1])
...
def cutwidth_MILP(G, lower_bound=0, solver=None, verbose=0,
    ...
    Cutwidth of a Cycle graph::
        ...
        sage: cw, L = cutwidth.cutwidth_MILP(G); cw                                     # optional - sage.numerical.mip
        2
        sage: cw == cutwidth.width_of_cut_decomposition(G, L)                           # optional - sage.numerical.mip
        True
    ...
    Comparison with exponential algorithm::
        ...
        sage: from sage.graphs.graph_decompositions import cutwidth
        sage: for i in range(2):  # long time                                           # optional - sage.numerical.mip
        ....:     G = graphs.RandomGNP(7, 0.3)
    ...
    Giving a too large lower bound::
        ...
        sage: cutwidth_MILP(G, lower_bound=G.size()+1)                                  # optional - sage.numerical.mip
        Traceback (most recent call last):
        ...
        MIPSolverException: ...
