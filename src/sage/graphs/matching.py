...
.. csv-table::
    ...
    :meth:`~M_alternating_even_mark` | Return the set of vertices each of which is reachable from the provided vertex through an (even length matching-alternating) path starting with an edge not in the matching and ending with an edge in the matching
