...
This implementation serves as an example of a class that implements
:class:`~sage.crypto.public_key.key_exchange.key_exchange_base.KeyExchangeBase`
rather than
:class:`~sage.crypto.public_key.key_exchange.key_exchange_base.CommutativeKeyExchangeBase`.
...
class SIDH(KeyExchangeBase):
    ...
    def secret_isogeny_path(
        ...
        :class:`~sage.crypto.public_key.key_exchange.key_exchange_base.KeyExchangeBase` may
