...
class ManifoldSubset(UniqueRepresentation, Parent):
    ...
    def subset_digraph(self, loops=False, quotient=False, open_covers=False, points=False, lower_bound=None):
        ...
        EXAMPLES::
            ...
            sage: D = M.subset_digraph(); D                                             # optional - sage.graphs
            Digraph on 4 vertices
            sage: D.edges(sort=True, key=lambda e: (e[0]._name, e[1]._name))            # optional - sage.graphs
            [(Set {U} of open subsets of the 3-dimensional differentiable manifold M,
             ...
             (Set {W} of open subsets of the 3-dimensional differentiable manifold M,
              Set {M} of open subsets of the 3-dimensional differentiable manifold M,
              None)]
            sage: D.plot(layout='acyclic')                                              # optional - sage.graphs sage.plot
            ...
            sage: D.relabel(label, inplace=False).plot(layout='acyclic')                # optional - sage.graphs sage.plot
            Graphics object consisting of 8 graphics primitives
        ...
        each nontrivial open cover of a subset::
            ...
            sage: D = M.subset_digraph(open_covers=True)                                # optional - sage.graphs
            sage: D.relabel(label, inplace=False).plot(layout='acyclic')                # optional - sage.graphs sage.plot
    ...
    def subset_poset(self, open_covers=False, points=False, lower_bound=None):
        ...
        EXAMPLES::
            ...
            sage: M = Manifold(3, 'M')
            sage: U = M.open_subset('U'); V = M.open_subset('V'); W = M.open_subset('W')
            sage: P = M.subset_poset(); P                                               # optional - sage.graphs
            Finite poset containing 4 elements
            sage: P.plot(element_labels={element: element._name for element in P})      # optional - sage.graphs sage.plot
            Graphics object consisting of 8 graphics primitives
            sage: VW = V.union(W)
            sage: P = M.subset_poset(); P                                               # optional - sage.graphs
            ...
            [Set {M} of open subsets of the 3-dimensional differentiable manifold M]
            sage: sorted(P.minimal_elements(), key=lambda v: v._name)                   # optional - sage.graphs
             [Set {U} of open subsets of the 3-dimensional differentiable manifold M,
              Set {V} of open subsets of the 3-dimensional differentiable manifold M,
              Set {W} of open subsets of the 3-dimensional differentiable manifold M]
            sage: from sage.manifolds.subset import ManifoldSubsetFiniteFamily
            sage: sorted(P.lower_covers(ManifoldSubsetFiniteFamily([M])), key=str)      # optional - sage.graphs
             [Set {U} of open subsets of the 3-dimensional differentiable manifold M,
        ...
        each nontrivial open cover of a subset::
            ...
            sage: P = M.subset_poset(open_covers=True); P                               # optional - sage.graphs
            Finite poset containing 6 elements
            sage: from sage.manifolds.subset import ManifoldSubsetFiniteFamily
            sage: sorted(P.upper_covers(ManifoldSubsetFiniteFamily([VW])), key=str)     # optional - sage.graphs
            [(Set {V} of open subsets of the 3-dimensional differentiable manifold M,
              Set {W} of open subsets of the 3-dimensional differentiable manifold M),
             Set {M} of open subsets of the 3-dimensional differentiable manifold M]
            sage: def label(element):
            ...
            ....:     except AttributeError:
            ....:         return '[' + ', '.join(sorted(x._name for x in element)) + ']'
            sage: P.plot(element_labels={element: label(element) for element in P})     # optional - sage.graphs sage.plot
            Graphics object consisting of 12 graphics primitives
    ...
    def superset_digraph(self, loops=False, quotient=False, open_covers=False, points=False, upper_bound=None):
        ...
        EXAMPLES::
            ...
            sage: U = M.open_subset('U'); V = M.open_subset('V'); W = M.open_subset('W')
            sage: VW = V.union(W)
            sage: P = V.superset_digraph(loops=False, upper_bound=VW); P                # optional - sage.graphs
    ...
    def superset_poset(self, open_covers=False, points=False, upper_bound=None):
        ...
        EXAMPLES::
            ...
            sage: U = M.open_subset('U'); V = M.open_subset('V'); W = M.open_subset('W')
            sage: VW = V.union(W)
            sage: P = V.superset_poset(); P                                             # optional - sage.graphs
    ...
    def declare_equal(self, *others):
        ...
        EXAMPLES::
            ...
            sage: P = M.subset_poset()                                                  # optional - sage.graphs
            sage: def label(element):
            ....:     return element._name
            sage: P.plot(element_labels={element: label(element) for element in P})     # optional - sage.graphs sage.plot
    ...
    def declare_empty(self):
        ...
        Emptiness is recorded as empty open covers::
            ...
            sage: P = M.subset_poset(open_covers=True, points=[b])                      # optional - sage.graphs
            sage: def label(element):
