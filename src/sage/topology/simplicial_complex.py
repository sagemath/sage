...
class SimplicialComplex(Parent, GenericCellComplex):
    ...
    def core(self, is_mutable=True):
        ...
        The core of a simplicial complex `\Delta` is the full subcomplex
        of `\Delta`, generated by a set of vertices `\{v \mid \mathrm{star}_\Delta v\}`.
