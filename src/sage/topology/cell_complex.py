...
class GenericCellComplex(SageObject):
    ...
    def homology(self, dim=None, base_ring=ZZ, subcomplex=None,
        ...
        EXAMPLES::
            ...
            {0: 0, 1: C2, 2: 0}
            sage: P.homology(reduced=False)                                             # optional - sage.modules
            {0: Z, 1: C2, 2: 0}
    ...
    def cohomology(self, dim=None, base_ring=ZZ, subcomplex=None,
        ...
        EXAMPLES::
            ...
            sage: circle.cohomology(0)                                                  # optional - sage.modules
            0
            sage: circle.cohomology(1)                                                  # optional - sage.modules
            Z
    ...
    def betti(self, dim=None, subcomplex=None):
        ...
        two-point space with itself::
            ...
            sage: (S*S*S).betti()                                                       # optional - sage.modules
            {0: 1, 1: 0, 2: 1}
            sage: (S*S*S).betti([1,2])                                                  # optional - sage.modules
            {1: 0, 2: 1}
            sage: (S*S*S).betti(2)                                                      # optional - sage.modules
            1

        Or build the two-sphere as a `\Delta`-complex::

            sage: S2 = delta_complexes.Sphere(2)
            sage: S2.betti([1,2])                                                       # optional - sage.modules
            {1: 0, 2: 1}

        Or as a cubical complex::

            sage: S2c = cubical_complexes.Sphere(2)
            sage: S2c.betti(2)                                                          # optional - sage.modules
            1
        """
        dict = {}
    ...
    def is_acyclic(self, base_ring=ZZ):
        ...
        EXAMPLES::
            ...
            sage: RP2.is_acyclic()                                                      # optional - sage.modules
            False
            sage: RP2.is_acyclic(QQ)                                                    # optional - sage.modules
            True
        ...
        equal to 1::
            ...
            0
            sage: P.is_acyclic()                                                        # optional - sage.modules
            False
        """
    ...
    def n_chains(self, n, base_ring=ZZ, cochains=False):
        ...
        EXAMPLES::
            ...
            sage: S2 = simplicial_complexes.Sphere(2)
            sage: S2.n_chains(1, QQ)                                                    # optional - sage.modules
            Free module generated by {(0, 1), (0, 2), (0, 3), (1, 2), (1, 3), (2, 3)}
             over Rational Field
            sage: list(S2.n_chains(1, QQ, cochains=False).basis())                      # optional - sage.modules
            [(0, 1), (0, 2), (0, 3), (1, 2), (1, 3), (2, 3)]
            sage: list(S2.n_chains(1, QQ, cochains=True).basis())                       # optional - sage.modules
    ...
    def cohomology_ring(self, base_ring=QQ):
        ...
        EXAMPLES::
            ...
            sage: K = simplicial_complexes.KleinBottle()
            sage: H = K.cohomology_ring(QQ); H                                          # optional - sage.modules
            Cohomology ring of Minimal triangulation of the Klein bottle
             over Rational Field
            sage: sorted(H.basis(), key=str)                                            # optional - sage.modules
            [h^{0,0}, h^{1,0}]
            sage: H = K.cohomology_ring(GF(2)); H                                       # optional - sage.modules sage.rings.finite_rings
            Cohomology ring of Minimal triangulation of the Klein bottle
             over Finite Field of size 2
            sage: sorted(H.basis(), key=str)                                            # optional - sage.modules sage.rings.finite_rings
            ...
            sage: H = X.cohomology_ring(QQ); H                                          # optional - sage.modules
            Cohomology ring of Delta complex with 3 vertices and 29 simplices
             over Rational Field
            sage: sorted(H.basis(1), key=str)                                           # optional - sage.modules
            [h^{1,0}, h^{1,1}, h^{1,2}, h^{1,3}]

            sage: H = simplicial_complexes.Torus().cohomology_ring(QQ); H               # optional - sage.modules
            Cohomology ring of Minimal triangulation of the torus
             over Rational Field
            sage: x = H.basis()[1,0]; x                                                 # optional - sage.modules
            h^{1,0}
            sage: y = H.basis()[1,1]; y                                                 # optional - sage.modules
            h^{1,1}

        You can compute cup products of cohomology classes::

            sage: x.cup_product(y)                                                      # optional - sage.modules
            -h^{2,0}
            sage: x * y # alternate notation                                            # optional - sage.modules
            -h^{2,0}
            sage: y.cup_product(x)                                                      # optional - sage.modules
            h^{2,0}
            sage: x.cup_product(x)                                                      # optional - sage.modules
            0
        ...
        Cohomology operations::
            ...
            sage: y = K.cohomology_ring(GF(2)).basis()[2,0]; y                          # optional - sage.graphs sage.groups sage.modules sage.rings.finite_rings
            h^{2,0}
            sage: y.Sq(1)                                                               # optional - sage.graphs sage.groups sage.modules sage.rings.finite_rings
            h^{3,0}
        ...
        ``K.set_immutable()`` above. Another example::
            ...
            sage: T.is_immutable()
            False
            sage: T.cohomology_ring()                                                   # optional - sage.modules
            Traceback (most recent call last):
            ...
