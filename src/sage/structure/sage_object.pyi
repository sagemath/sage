...
class SageObject:
    ...
    def _gap_(self, G: Any | None = ...) -> Any: ...
    def _gap_init_(self) -> str: ...
    def _libgap_(self) -> Any: ...
    def _gp_(self, G: Any | None = ...) -> Any: ...
    def _gp_init_(self) -> str: ...
    def _kash_(self, G: Any | None = ...) -> Any: ...
    def _kash_init_(self) -> str: ...
    def _axiom_(self, G: Any | None = ...) -> Any: ...
    def _axiom_init_(self) -> str: ...
    def _fricas_(self, G: Any | None = ...) -> Any: ...
    def _fricas_init_(self) -> str: ...
    def _giac_(self, G: Any | None = ...) -> Any: ...
    def _giac_init_(self) -> str: ...
    def _maxima_(self, G: Any | None = ...) -> Any: ...
    def _maxima_init_(self) -> str: ...
    def _maxima_lib_(self, G: Any | None = ...) -> Any: ...
    def _maxima_lib_init_(self) -> str: ...
    def _magma_init_(self, magma: Any) -> str: ...
    def _macaulay2_(self, G: Any | None = ...) -> Any: ...
    def _macaulay2_init_(self, macaulay2: Any | None = ...) -> str: ...
    def _maple_(self, G: Any | None = ...) -> Any: ...
    def _maple_init_(self) -> str: ...
    def _mathematica_(self, G: Any | None = ...) -> Any: ...
    def _mathematica_init_(self) -> str: ...
    def _mathics_(self, G: Any | None = ...) -> Any: ...
    def _mathics_init_(self) -> str: ...
    def _octave_(self, G: Any | None = ...) -> Any: ...
    def _octave_init_(self) -> str: ...
    def _polymake_(self, G: Any | None = ...) -> Any: ...
    def _polymake_init_(self) -> str: ...
    def _r_init_(self) -> str: ...
    def _singular_(self, G: Any | None = ...) -> Any: ...
    def _singular_init_(self) -> str: ...
    def __pari__(self) -> Any: ...
    def _pari_init_(self) -> str: ...
    def _regina_(self, G: Any | None = ...) -> Any: ...
