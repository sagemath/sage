...
class Option():
    ...
    def __bool__(self) -> bool:
        ...
        EXAMPLES::
            ...
            sage: RiggedConfigurations.options.half_width_boxes_type_B                          # optional - sage.combinat sage.graphs sage.modules
            True
            sage: 'yes' if RiggedConfigurations.options.half_width_boxes_type_B else 'no'       # optional - sage.combinat sage.graphs sage.modules
            'yes'
            sage: RiggedConfigurations.options.half_width_boxes_type_B = False                  # optional - sage.combinat sage.graphs sage.modules
            sage: 'yes' if RiggedConfigurations.options.half_width_boxes_type_B else 'no'       # optional - sage.combinat sage.graphs sage.modules
            'no'
            sage: RiggedConfigurations.options._reset()                                         # optional - sage.combinat sage.graphs sage.modules
        """
