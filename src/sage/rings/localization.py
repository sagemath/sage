...
three elements::
    ...
    Multivariate Polynomial Ring in u0, u1, u2, q over Integer Ring localized at (q, q + 1, u2, u1 - u2, u1, u0 - u1, u0 - u2, u0, u2*q - u0, u2*q - u1, u1*q - u0, u1*q - u2, u0*q - u1, u0*q - u2)
...
Obtain specializations in positive characteristic::
    ...
    Ring morphism:
      From: Multivariate Polynomial Ring in u0, u1, u2, q over Integer Ring localized at (q, q + 1, u2, u1 - u2, u1, u0 - u1, u0 - u2, u0, u2*q - u0, u2*q - u1, u1*q - u0, u1*q - u2, u0*q - u1, u0*q - u2)
...
Obtain specializations in characteristic 0::
    ...
    Ring morphism:
      From: Multivariate Polynomial Ring in u0, u1, u2, q over Integer Ring localized at (q, q + 1, u2, u1 - u2, u1, u0 - u1, u0 - u2, u0, u2*q - u0, u2*q - u1, u1*q - u0, u1*q - u2, u0*q - u1, u0*q - u2)
      To:   Fraction Field of Quotient of Multivariate Polynomial Ring in x, y, z, t over Rational Field by the ideal (x + y + z)
      Defn: u0 |--> -ybar - zbar
            u1 |--> ybar
            u2 |--> zbar
            q |--> tbar
