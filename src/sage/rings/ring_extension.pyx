...
cdef class RingExtension_generic(CommutativeAlgebra):
    ...
    def absolute_base(self):
        ...
        EXAMPLES::
            ...
            Finite Field of size 5
            sage: L.absolute_base()                                                     # needs sage.rings.finite_rings
            Finite Field of size 5
    ...
    def degree(self, base):
        ...
        EXAMPLES::
            ...
            3
            sage: B.degree(GF(5^2))                                                     # needs sage.rings.finite_rings
            6
    ...
    def fraction_field(self, extend_base=False):
        ...
        EXAMPLES::
            ...
            sage: x = polygen(ZZ, 'x')
            sage: A.<a> = ZZ.extension(x^2 - 5)                                         # needs sage.rings.number_field
