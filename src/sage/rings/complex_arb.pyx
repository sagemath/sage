...
::
    ...
    sage: SR.coerce(CBF(0.42 + 3.33*I))                                                 # optional - sage.symbolic
    [0.4200000000000000 +/- ...e-17] + [3.330000000000000 +/- ...e-17]*I

Check that :trac:`19839` is fixed::

    sage: log(SR(CBF(0.42))).pyobject().parent()                                        # optional - sage.symbolic
...
class ComplexBallField(UniqueRepresentation, sage.rings.abc.ComplexBallField):
    ...
    def _element_constructor_(self, x=None, y=None):
        ...
        EXAMPLES::
            ...
            sage: CBF(infinity, NaN)                                                    # optional - sage.symbolic
            [+/- inf] + nan*I
            sage: CBF(x)                                                                # optional - sage.symbolic
            Traceback (most recent call last):
            ...
        ...
        The following conversions used to yield incorrect enclosures::
            ...
            sage: a = CBF(airy_ai(1)); a                                                # optional - sage.symbolic
            [0.1352924163128814 +/- 6.95e-17]
            sage: a.overlaps(ComplexBallField(100).one().airy_ai())                     # optional - sage.symbolic
            True
            sage: v = CBF(zetaderiv(1, 3/2)); v                                         # optional - sage.symbolic
            [-3.932239737431101 +/- 5.58e-16]
            sage: v.overlaps(ComplexBallField(100)(3/2).zetaderiv(1))                   # optional - sage.symbolic
            True
        """
        try:
    ...
    def integral(self, func, a, b, params=None,
        ...
        Here the integration path crosses the branch cut of the square root::
            ...
            ....:     else:
            ....:         return z.sqrt()
            sage: CBF.integral(my_sqrt, -1 + CBF(i), -1 - CBF(i))                       # optional - sage.symbolic
        ...
        even when the path does not touch the branch cut::
            ...
            sage: RBF(integral(sqrt(x), x, 1, 2))  # long time                          # optional - sage.symbolic
            [1.21895141649746 +/- ...e-15]
...
cdef class ComplexBall(RingElement):
    ...
    def __init__(self, parent, x=None, y=None):
        ...
        TESTS::
            ...
            sage: ComplexBall(CBF100, RBF(pi))                                          # optional - sage.symbolic
            [3.141592653589793 +/- ...e-16]
    ...
    def __reduce__(self):
        ...
        TESTS::
            ...
            sage: [loads(dumps(b)).identical(b) for b in                                # optional - sage.symbolic
    ...
    def nbits(self):
        ...
        EXAMPLES::
            ...
            10
            sage: CBF(1/3, NaN).nbits()                                                 # optional - sage.symbolic
            53
            sage: CBF(NaN).nbits()                                                      # optional - sage.symbolic
            0
        """
    ...
    def round(self):
        ...
        more information)::
            ...
            sage: b = CBF(exp(I*pi/3).n(100))                                           # optional - sage.symbolic
    ...
    def accuracy(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(exp(I*pi/3)).accuracy()                                           # optional - sage.symbolic
            51
    ...
    def is_NaN(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(NaN).is_NaN()                                                     # optional - sage.symbolic
            True
    ...
    def is_nonzero(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(pi, 1/3).is_nonzero()                                             # optional - sage.symbolic
            True
    ...
    def contains_exact(self, other):
        ...
        EXAMPLES::
            ...
            sage: CBF(sqrt(2)).contains_exact(sqrt(2))                                  # optional - sage.symbolic
            Traceback (most recent call last):
            ...
    ...
    def __pow__(base, expo, _):
        ...
        EXAMPLES::
            ...
            sage: CBF(-1)**(1/2)
            1.000000000000000*I
            sage: CBF(e)**CBF(i*pi)                                                     # optional - sage.symbolic
        ...
        TESTS::
            ...
            sage: (CBF(e)**CBF(i))**RBF(pi)                                             # optional - sage.symbolic
            [-1.0000000000000 +/- ...e-15] + [+/- ...e-15]*I
            sage: CBF(2*i)**10r
            -1024.000000000000
            sage: CBF(1,1) ^ -1r
            0.5000000000000000 - 0.5000000000000000*I
            sage: CBF(2)**SR.var('x')                                                   # optional - sage.symbolic
            2.000000000000000^x
        """
    ...
    cpdef pow(self, expo, analytic=False):
        ...
        TESTS::
            ...
            sage: CBF(2).pow(SR.var('x'))                                               # optional - sage.symbolic
            Traceback (most recent call last):
            ...
    ...
    def exp(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(i*pi).exp()                                                       # optional - sage.symbolic
    ...
    def exppii(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(1/2).exppii()
            1.000000000000000*I
            sage: CBF(0, -1/pi).exppii()                                                # optional - sage.symbolic
    ...
    def sin(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(i*pi).sin()                                                       # optional - sage.symbolic
    ...
    def cos(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(i*pi).cos()                                                       # optional - sage.symbolic
    ...
    def tan(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(pi/2, 1/10).tan()                                                 # optional - sage.symbolic
            [+/- ...e-14] + [10.03331113225399 +/- ...e-15]*I
            sage: CBF(pi/2).tan()                                                       # optional - sage.symbolic
            nan
        """
        cdef ComplexBall res = self._new()
        if _do_sig(prec(self)): sig_on()
    ...
    def cot(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(pi, 1/10).cot()                                                   # optional - sage.symbolic
            [+/- ...e-14] + [-10.03331113225399 +/- ...e-15]*I
            sage: CBF(pi).cot()                                                         # optional - sage.symbolic
            nan
        """
        cdef ComplexBall res = self._new()
        if _do_sig(prec(self)): sig_on()
    ...
    def tanh(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(0, pi/2).tanh()                                                   # optional - sage.symbolic
            nan*I
        """
        cdef ComplexBall res = self._new()
        if _do_sig(prec(self)): sig_on()
    ...
    def coth(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(0, pi).coth()                                                     # optional - sage.symbolic
            nan*I
        """
        cdef ComplexBall res = self._new()
        if _do_sig(prec(self)): sig_on()
    ...
    def sech(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(pi/2, 1/10).sech()                                                # optional - sage.symbolic
    ...
    def csch(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(i*pi).csch()                                                      # optional - sage.symbolic
            nan*I
        """
        cdef ComplexBall res = self._new()
        if _do_sig(prec(self)): sig_on()
    ...
    def hypergeometric(self, a, b, bint regularized=False):
        ...
        EXAMPLES::
            ...
            sage: CBF(1, pi/2).hypergeometric([], [])                                   # optional - sage.symbolic
            [+/- ...e-16] + [2.71828182845904 +/- ...e-15]*I

            sage: CBF(1, pi).hypergeometric([1/4], [1/4])                               # optional - sage.symbolic
            [-2.7182818284590 +/- ...e-14] + [+/- ...e-14]*I

            sage: CBF(1000, 1000).hypergeometric([10], [AA(sqrt(2))])                   # optional - sage.symbolic
            [9.79300951360e+454 +/- ...e+442] + [5.522579106816e+455 +/- ...e+442]*I
            sage: CBF(1000, 1000).hypergeometric([100], [AA(sqrt(2))])                  # optional - sage.symbolic
        ...
        TESTS::
            ...
            sage: CBF(0, 1).hypergeometric([QQbar(sqrt(2)), RLF(pi)], [1r, 1/2])        # optional - sage.symbolic
    ...
    def hypergeometric_U(self, a, b):
        ...
        EXAMPLES::
            ...
            sage: CBF(1000, 1000).hypergeometric_U(RLF(pi), -100)                       # optional - sage.symbolic
    ...
    def airy(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(10*pi).airy()                                                     # optional - sage.symbolic
    ...
    def Ei(self):
        ...
        TESTS:
            ...
            sage: CBF(Ei(I))  # abs tol 1e-16                                           # optional - sage.symbolic
    ...
    def Si(self):
        ...
        TESTS:
            ...
            sage: CBF(Si(I))                                                            # optional - sage.symbolic
    ...
    def Ci(self):
        ...
        TESTS:
            ...
            sage: CBF(Ci(I))  # abs tol 1e-17                                           # optional - sage.symbolic
    ...
    def Shi(self):
        ...
        TESTS:
            ...
            sage: CBF(Shi(I))  # abs tol 1e-15                                          # optional - sage.symbolic
    ...
    def Chi(self):
        ...
        TESTS:
            ...
            sage: CBF(Chi(I))  # abs tol 1e-16                                          # optional - sage.symbolic
    ...
    def li(self, bint offset=False):
        ...
        EXAMPLES::
            ...
            sage: li(0).n()                                                             # optional - sage.symbolic
            0.000000000000000
            sage: Li(0).n()                                                             # optional - sage.symbolic
            -1.04516378011749
        ...
        TESTS::
            ...
            sage: CBF(li(0))                                                            # optional - sage.symbolic
            0
            sage: CBF(Li(0))                                                            # optional - sage.symbolic
            [-1.04516378011749...]
        """
    ...
    def modular_lambda(self):
        ...
        EXAMPLES::
            ...
            sage: tau = CBF(sqrt(2),pi)                                                 # optional - sage.symbolic
            sage: tau.modular_lambda()                                                  # optional - sage.symbolic
            [-0.00022005123884157 +/- ...e-18] + [-0.00079787346459944 +/- ...e-18]*I
            sage: (tau + 2).modular_lambda()                                            # optional - sage.symbolic
            [-0.00022005123884157 +/- ...e-18] + [-0.00079787346459944 +/- ...e-18]*I
            sage: (tau / (1 - 2*tau)).modular_lambda()                                  # optional - sage.symbolic
    ...
    def elliptic_p(self, tau, n=None):
        ...
        EXAMPLES::
            ...
            sage: tau = CBF(1,4)
            sage: z = CBF(sqrt(2), sqrt(3))                                             # optional - sage.symbolic
            sage: z.elliptic_p(tau)                                                     # optional - sage.symbolic
            [-3.28920996772709 +/- ...e-15] + [-0.0003673767302933 +/- ...e-17]*I
            sage: (z + tau).elliptic_p(tau)                                             # optional - sage.symbolic
            [-3.28920996772709 +/- ...e-15] + [-0.000367376730293 +/- ...e-16]*I
            sage: (z + 1).elliptic_p(tau)                                               # optional - sage.symbolic
            [-3.28920996772709 +/- ...e-15] + [-0.0003673767302933 +/- ...e-17]*I

            sage: z.elliptic_p(tau, 3)                                                  # optional - sage.symbolic
            [[-3.28920996772709 +/- ...e-15] + [-0.0003673767302933 +/- ...e-17]*I,
             [0.002473055794309 +/- ...e-16] + [0.003859554040267 +/- ...e-16]*I,
             [-0.01299087561709 +/- ...e-15] + [0.00725027521915 +/- ...e-15]*I]
            sage: (z + 3 + 4*tau).elliptic_p(tau, 3)                                    # optional - sage.symbolic
    ...
    def elliptic_invariants(self):
        ...
        EXAMPLES::
            ...
            sage: CBF(sqrt(2)/2, sqrt(2)/2).elliptic_invariants()                       # optional - sage.symbolic
