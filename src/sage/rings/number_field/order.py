...
class Order(Parent, sage.rings.abc.Order):
    ...
    def conductor(self, as_self_ideal=False):
        ...
        For orders in quadratic number fields, the method returns an integer. This will be deprecated.
        ...
        For orders in fields of degree larger than 2, we return an ideal.
