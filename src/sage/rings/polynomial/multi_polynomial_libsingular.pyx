...
cdef class MPolynomial_libsingular(MPolynomial_libsingular_base):
    ...
    def in_subalgebra(self, J, algorithm='algebra_containment', *, certificate=False):
        ...
        - ``certificate`` -- An expression that evaluates to True or False. If
          it evaluates to False (the default) then return either True or False.
          If it evaluates to True and 'algorithm' is set to 'groebner', return
          the polynomial generated by the algorithm if such a polynomial exists,
          otherwise return None. If a string is provided which evaluates to
          True then this string will be used as the name of the variables in the
          returned polynomial, otherwise the name will be 'newgens'
