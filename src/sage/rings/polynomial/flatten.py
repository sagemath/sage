...
class FlatteningMorphism(Morphism):
    ...
    def __init__(self, domain):
        ...
        TESTS::
            ...
            True
        """
        if not is_PolynomialRing(domain) and not isinstance(domain, MPolynomialRing_base):
        ...
        while is_PolynomialRing(ring) or isinstance(ring, MPolynomialRing_base):
...
class UnflatteningMorphism(Morphism):
    ...
    def __init__(self, domain, codomain):
        ...
        if not is_PolynomialRing(codomain) and not isinstance(codomain, MPolynomialRing_base):
...
class SpecializationMorphism(Morphism):
    ...
    def __init__(self, domain, D):
        ...
        new_vars = []
        R = domain
        while is_PolynomialRing(R) or isinstance(R, MPolynomialRing_base) or isinstance(R, FractionField_generic):
