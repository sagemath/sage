...
cdef class Polynomial_complex_arb(Polynomial):
    ...
    EXAMPLES::
        ...
        sage: Pol(), Pol(1), Pol([0,1,2]), Pol({1: pi, 3: i})                           # optional - sage.symbolic
        (0,
         1.000000000000000,
    ...
    def __init__(self, parent, x=None, check=True, is_gen=False, construct=False):
        ...
        TESTS::
            ...
            0
            sage: Polynomial_complex_arb(Pol, {10: pi})                                 # optional - sage.symbolic
            ([3.141592653589793 +/- ...e-16])*x^10
            sage: Polynomial_complex_arb(Pol, pi)                                       # optional - sage.symbolic
    ...
    def quo_rem(self, divisor):
        ...
        EXAMPLES::
            ...
            sage: (x^3/7 - CBF(i)).quo_rem(x + CBF(pi))                                 # optional - sage.symbolic
    ...
    def _exp_series(self, long n):
        ...
        EXAMPLES::
            ...
            sage: (CBF(0, pi) + x)._exp_series(4)                                       # optional - sage.symbolic
    ...
    def __call__(self, *x, **kwds):
        ...
        EXAMPLES::
            ...
            sage: Pol.<x> = CBF[]
            sage: pol = x^2 - 1
            sage: pol(CBF(pi))                                                          # optional - sage.symbolic
