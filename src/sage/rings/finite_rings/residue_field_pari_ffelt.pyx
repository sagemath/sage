...
class ResidueFiniteField_pari_ffelt(ResidueField_generic, FiniteField_pari_ffelt):
    ...
    EXAMPLES::
        ...
        sage: P = K.ideal(923478923).factor()[0][0]                                     # needs sage.rings.number_field
