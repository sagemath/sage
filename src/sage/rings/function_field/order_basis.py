...
class FunctionFieldOrder_basis(FunctionFieldOrder):
    ...
    EXAMPLES::
        ...
        sage: L.<y> = K.extension(y^4 + x*y + 4*x + 1)                                              # needs sage.rings.finite_rings sage.rings.function_field
        sage: O = L.equation_order(); O                                                             # needs sage.rings.finite_rings sage.rings.function_field
    ...
    is ``True``)::
        ...
        sage: L.order(L(x))                                                                         # needs sage.rings.function_field
        Traceback (most recent call last):
        ...
        ValueError: basis (1, x, x^2, x^3, x^4) is not linearly independent
        sage: sage.rings.function_field.order_basis.FunctionFieldOrder_basis((y,y,y^3,y^4,y^5))     # needs sage.rings.function_field
        Traceback (most recent call last):
        ...
    ...
    def ideal(self, *gens):
        ...
        A fractional ideal of a nontrivial extension::
            ...
            sage: L.<y> = K.extension(y^2 - x^3 - 1)                                                # needs sage.rings.function_field
            sage: S = L.equation_order()                                                            # needs sage.rings.function_field
            sage: S.ideal(1/y)                                                                      # needs sage.rings.function_field
            Ideal (1, (6/(x^3 + 1))*y) of Order in Function field in y defined by y^2 + 6*x^3 + 6
            sage: I2 = S.ideal(x^2 - 4); I2                                                         # needs sage.rings.function_field
            Ideal (x^2 + 3) of Order in Function field in y defined by y^2 + 6*x^3 + 6
            sage: I2 == S.ideal(I)                                                                  # needs sage.rings.function_field
            True
        """
        if len(gens) == 1:
            gens = gens[0]
    ...
    def coordinate_vector(self, e):
        ...
        EXAMPLES::
            ...
            sage: L.<y> = K.extension(y^4 + x*y + 4*x + 1)                                          # needs sage.rings.function_field
            sage: O = L.equation_order()                                                            # needs sage.rings.function_field
            sage: f = (x + y)^3                                                                     # needs sage.rings.function_field
            sage: O.coordinate_vector(f)                                                            # needs sage.rings.function_field
            (x^3, 3*x^2, 3*x, 1)
        """
...
class FunctionFieldOrderInfinite_basis(FunctionFieldOrderInfinite):
    ...
    EXAMPLES::
        ...
        sage: K.<x> = FunctionField(GF(7)); R.<y> = K[]
        sage: L.<y> = K.extension(y^4 + x*y + 4*x + 1)                                              # needs sage.rings.finite_rings sage.rings.function_field
        sage: O = L.equation_order_infinite(); O                                                    # needs sage.rings.finite_rings sage.rings.function_field
    ...
    ``check`` is ``True``)::
        ...
        sage: O = L.order_infinite_with_basis([1, y, 1/x^2*y^2, y^3]); O                            # needs sage.rings.finite_rings sage.rings.function_field
        Traceback (most recent call last):
        ...
    ...
    is ``True``)::
        ...
        sage: O = L.order_infinite_with_basis([1, y, 1/x^2*y^2, 1 + y]); O                          # needs sage.rings.finite_rings sage.rings.function_field
        Traceback (most recent call last):
        ...
    ...
    in the module spanned by it::
        ...
        sage: O = L.order_infinite_with_basis([1 + 1/x*y, 1/x*y, 1/x^2*y^2, 1/x^3*y^3]); O          # needs sage.rings.finite_rings sage.rings.function_field
        Infinite order in Function field in y defined by y^4 + x*y + 4*x + 1
        sage: O.basis()                                                                             # needs sage.rings.finite_rings sage.rings.function_field
