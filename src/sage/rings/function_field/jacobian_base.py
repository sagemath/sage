...
class Jacobians(Schemes):
    """
    The category of Jacobians attached to function fields.
    """
    pass
...
class JacobianGroupFunctor(ConstructionFunctor):
    ...
    def __init__(self, field):
        ...
        """
        super().__init__(Jacobians(), CommutativeAdditiveGroups())
...
class JacobianGroup_base(Parent):
    ...
    def construction(self):
        ...
        """
        K = self._function_field.constant_base_field()
        return (JacobianGroupFunctor(K), self._parent)
...
class Jacobian_base(Parent):
    ...
    def __init__(self, function_field, base_div, **kwds):
        ...
        super().__init__(category=Jacobians(), base=function_field.constant_base_field(),
                         facade=True)
