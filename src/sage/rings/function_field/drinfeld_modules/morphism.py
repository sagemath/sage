...
class DrinfeldModuleMorphism(Morphism, UniqueRepresentation,
    ...
    def __invert__(self):
        ...
        TESTS::
            ...
            sage: f = phi.hom(K.random_element())  # known bug (sporadic ValueError: the input does not define an isogeny, #37071)
            sage: g = ~f  # known bug (sporadic ValueError: the input does not define an isogeny, #37071)

            sage: (f*g).is_identity()  # known bug (sporadic ValueError: the input does not define an isogeny, #37071)
            True
            sage: (g*f).is_identity()  # known bug (sporadic ValueError: the input does not define an isogeny, #37071)
            True
