...
class LazyPowerSeriesRing(LazySeriesRing):
    ...
    def _element_constructor_(self, x=None, valuation=None, constant=None, degree=None, coefficients=None, check=True):
        ...
        Finally ``x`` can be in the corresponding fraction field::
            ...
            1 + (a+b) - a*b - (a^2*b+a*b^2+c^3) + (a^2*b^2-a*c^3-b*c^3) + (a^3*b^2+a^2*b^3+2*a*b*c^3) -
             (a^3*b^3-2*a^2*b*c^3-2*a*b^2*c^3-c^6) + O(a,b,c)^7
    ...
    def some_elements(self):
        ...
        EXAMPLES::
            ...
            [0,
             ...
             1 + (q+t) + (q^2-q*t+t^2) + (q^3+t^3) + (q^4+q^3*t+q*t^3+t^4) + (q^5-q^4*t+q^3*t^2+q^2*t^3-q*t^4+t^5) +
