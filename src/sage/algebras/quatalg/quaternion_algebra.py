...
class QuaternionFractionalIdeal_rational(QuaternionFractionalIdeal):
    ...
    def pushforward(self, J, side=None):
        ...
        if not isinstance(J, QuaternionFractionalIdeal_rational):
            raise TypeError("can only pushforward through an ideal")
        ...
        if side == "left":
            ...
            I3 = J.conjugate() * self.intersection(J)
            I3 = I3 * (1 / Jnorm)
            return I3
        ...
        if side is None:
            same_left_order = self.left_order() == J.left_order()
            same_right_order = self.right_order() == J.right_order()
    ...
    def pullback(self, J, side=None):
        ...
        if side is None:
            is_side_left = self.left_order() == J.right_order()
            is_side_right = self.right_order() == J.left_order()
