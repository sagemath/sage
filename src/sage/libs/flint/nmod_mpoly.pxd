...
cdef extern from "flint_wrap.h":
    void nmod_mpoly_ctx_init(nmod_mpoly_ctx_t ctx, slong nvars, const ordering_t ord, ulong n) noexcept
    ...
    ulong nmod_mpoly_ctx_modulus(const nmod_mpoly_ctx_t ctx) noexcept
    ...
    ulong * nmod_mpoly_term_coeff_ref(nmod_mpoly_t A, slong i, const nmod_mpoly_ctx_t ctx) noexcept
    ...
    void nmod_mpoly_randtest_bits(nmod_mpoly_t A, flint_rand_t state, slong length, ulong exp_bits, const nmod_mpoly_ctx_t ctx) noexcept
