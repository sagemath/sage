...
cdef extern from "flint_wrap.h":
    ...
    void arb_mat_spd_lll_reduce(fmpz_mat_t U, const arb_mat_t A, double delta, double eta, slong prec) noexcept
    bint arb_mat_spd_is_lll_reduced(const arb_mat_t A, double delta, double eta, slong prec) noexcept
