...
def construct_phi(matrices):
    ...
    ::
        ...
        sage: construct_phi(L)
        [
        [2 1 0]  [0 1 1]  [2 1 1]  [2 2 1]  [2 0 2]  [2 2 2]  [2 2 2]  [2 2 2]
        [2 0 1]  [2 1 1]  [1 2 1]  [2 2 1]  [2 2 2]  [2 1 2]  [1 2 2]  [2 2 2]
        [0 0 1], [1 2 2], [0 1 2], [0 0 1], [2 1 2], [2 0 2], [1 2 2], [2 2 2],
        <BLANKLINE>
        [2 2 2]  [1 2 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 1 2]  [2 2 2]
        [2 2 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 1 2]  [2 2 2]  [2 2 2]  [2 2 2]
        [0 1 2], [2 2 2], [1 2 2], [0 0 1], [2 1 2], [2 0 2], [2 2 2], [2 1 2]
        ]
    ...
    Tests::
        ...
        sage: construct_phi(L)
        [
        [2 1 0]  [0 2 1]  [2 1 0]  [2 2 0]  [2 0 2]  [2 2 0]  [1 2 2]  [2 1 2]
        [2 0 0]  [1 0 0]  [0 0 2]  [2 2 0]  [2 1 0]  [2 0 2]  [0 2 2]  [0 2 1]
        [2 0 2], [1 1 2], [0 1 0], [2 2 2], [2 1 2], [2 0 0], [2 2 2], [2 2 2],
        <BLANKLINE>
        [1 2 2]  [2 2 2]  [0 1 2]  [2 2 2]  [2 2 2]  [2 2 0]  [2 1 2]  [2 2 2]
        [2 2 2]  [2 2 0]  [2 1 0]  [0 2 0]  [2 2 0]  [2 2 2]  [2 0 2]  [2 0 2]
        [1 0 0], [2 2 0], [2 2 2], [0 0 2], [2 2 2], [2 2 0], [2 2 2], [2 2 2],
        <BLANKLINE>
        [2 1 2]  [2 0 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 2 2]
        [2 2 2]  [2 2 0]  [2 0 0]  [2 2 2]  [1 2 2]  [2 2 2]  [2 1 2]  [2 2 2]
        [2 1 0], [2 2 2], [2 0 2], [2 2 2], [2 2 2], [0 2 2], [2 2 2], [0 2 1],
        <BLANKLINE>
        [2 2 2]  [2 2 0]  [2 2 2]  [2 2 2]  [2 2 2]  [0 2 2]  [2 2 2]  [2 2 2]
        [2 0 0]  [2 2 2]  [0 2 2]  [0 1 2]  [2 2 2]  [2 2 2]  [0 0 2]  [2 2 2]
        [2 2 2], [2 2 2], [2 2 2], [2 2 2], [2 1 0], [2 2 2], [0 2 0], [2 2 0],
        <BLANKLINE>
        [2 2 2]  [2 0 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 2 2]
        [2 2 2]  [2 2 2]  [2 0 2]  [2 2 2]  [2 2 2]  [2 2 2]  [2 2 2]
        [2 0 2], [2 2 2], [2 0 0], [1 2 2], [2 1 2], [2 0 0], [0 1 2]
        ]
