...
def _linear_extension_gen(_D, list _le, list _a, list _b, list _is_plus, Py_ssize_t i):
    ...
    TESTS::
        ...
        sage: [e for e in _linear_extension_gen(D, le, a, b, [True], len(a)-1)]         # optional - sage.rings.finite_rings
        [[0, 2, 1, 3, 4]]
...
def linear_extension_iterator(D):
    ...
    EXAMPLES::
        ...
        sage: D = Poset({ 0:[1,2], 1:[3], 2:[3,4] })._hasse_diagram
        sage: list(linear_extension_iterator(D))                                        # optional - sage.rings.finite_rings
        [[0, 1, 2, 3, 4],
         [0, 2, 1, 3, 4],
         [0, 2, 1, 4, 3],
         [0, 2, 4, 1, 3],
        ...
        sage: len(list(linear_extension_iterator(D)))                                   # optional - sage.rings.finite_rings
        48
