...
class StandardRibbonShapedTableaux_shape(StandardRibbonShapedTableaux):
    ...
    EXAMPLES::
        ...
        [[None, 1, 2], [3, 4]]
        sage: StandardRibbonShapedTableaux([2,2]).cardinality()                         # optional - sage.graphs sage.modules sage.rings.finite_rings
        5
        sage: StandardRibbonShapedTableaux([2,2]).list()                                # optional - sage.graphs sage.modules sage.rings.finite_rings
        [[[None, 1, 3], [2, 4]],
         [[None, 1, 2], [3, 4]],
         [[None, 2, 3], [1, 4]],
         [[None, 2, 4], [1, 3]],
         [[None, 1, 4], [2, 3]]]
        sage: StandardRibbonShapedTableaux([3,2,2]).cardinality()                       # optional - sage.graphs sage.modules sage.rings.finite_rings
        155
    """
    @staticmethod
    ...
    def __iter__(self):
        ...
        EXAMPLES::
            ...
            sage: [t for t in StandardRibbonShapedTableaux([2,2])]                      # optional - sage.graphs sage.rings.finite_rings
            [[[None, 1, 3], [2, 4]],
             [[None, 1, 2], [3, 4]],
             [[None, 2, 3], [1, 4]],
             [[None, 2, 4], [1, 3]],
