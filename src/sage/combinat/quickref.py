...
Combinatorial objects::
    ...
    sage: P = Partitions(10000); P.cardinality()                                        # optional - sage.libs.flint
    ...
    sage: DyckWord([1,0,1,0,1,1,0,0]).to_binary_tree()                                  # optional - sage.graphs
    [., [., [[., .], .]]]
...
:ref:`Root systems, Coxeter and Weyl groups <sage.combinat.root_system.all>`::
    ...
    sage: WeylGroup(["B",3]).bruhat_poset()                                             # optional - sage.graphs sage.modules
    Finite poset containing 48 elements
    sage: RootSystem(["A",2,1]).weight_lattice().plot()                   # not tested  # optional - sage.graphs sage.modules sage.plot
...
:mod:`Symmetric functions and combinatorial Hopf algebras <sage.combinat.algebraic_combinatorics>`::
    ...
    sage: Sym = SymmetricFunctions(QQ); Sym.inject_shorthands(verbose=False)            # optional - sage.sage.modules
    sage: m( ( h[2,1] * (1 + 3 * p[2,1]) ) + s[2](s[3]) )                               # optional - sage.sage.modules
...
:ref:`Discrete groups, Permutation groups <sage.groups.groups_catalog>`::
    ...
    sage: M.an_element() * S.an_element()                                               # optional - sage.groups
    x0

Graph theory, posets, lattices (:ref:`sage.graphs`, :ref:`sage.combinat.posets.all`)::

    sage: Poset({1: [2,3], 2: [4], 3: [4]}).linear_extensions().cardinality()           # optional - sage.graphs sage.modules
    2
"""
