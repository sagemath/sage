...
class DisplayManager(SageObject):
    ...
    def graphics_from_save(self, save_function, save_kwds,
        ...
        EXAMPLES::
            ...
            sage: out = dm.graphics_from_save(plt.save, dict(), '.png',                 # optional - sage.plot
            ....:                             dm.types.OutputImagePng)
            sage: out                                                                   # optional - sage.plot
            OutputImagePng container
            sage: out.png.get().startswith(b'\x89PNG')                                  # optional - sage.plot
            True
            sage: out.png.filename()   # random                                         # optional - sage.plot
