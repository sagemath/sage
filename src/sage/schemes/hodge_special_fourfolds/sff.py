...
class Embedded_projective_variety(AlgebraicScheme_subscheme_projective):
    ...
    - ``saturate`` -- (default: ``True``) whether to saturate the ideal generated by ``polys``
    - ``minbase`` -- (default: ``True``) whether to compute a minimal set of generators for the ideal
    ...
    ::
        ...
        Type
    """
    def __init__(self, PP, polys=[], saturate=True, minbase=True) -> None:
        r"""See :class:`Embedded_projective_variety` for documentation."""
        if not isinstance(saturate, bool):
            raise TypeError("parameter 'saturate' must be a boolean")
        if not isinstance(minbase, bool):
            raise TypeError("parameter 'minbase' must be a boolean")
        ...
        if len(polys) > 0:
            ...
            if saturate:
                I = _saturation(ideal(polys))
                polys = I.gens()
            if minbase:
                polys = _minbase(ideal(polys))
    ...
    def topological_support(self):
        ...
        try:
            ...
            pass
        Supp = Embedded_projective_variety(self.ambient_space(), self.defining_ideal().radical().gens(), saturate=False, minbase=False)
        if Supp == self:
            Supp = self
    ...
    def point(self, verbose=None, algorithm='sage'):
        ...
        p = Embedded_projective_variety(self.ambient_space(), polys, saturate=False, minbase=True)
    ...
    def singular_locus(self, saturate=False):
        r"""
        ...
        try:
            ...
            self._singular_locus = Embedded_projective_variety(self.ambient_space(), self.Jacobian().gens(), saturate=saturate, minbase=True)
            return self._singular_locus
    ...
    def _homogeneous_component(self, n, minbase=True):
        r"""
    ...
    def linear_span(self):
        ...
        EXAMPLES::
            ...
            True
        """
        L = self._homogeneous_component(1, minbase=True)
        if len(L) == 0:
            return self.ambient()
        return Embedded_projective_variety(self.ambient_space(), L,  saturate=False, minbase=False)
    ...
    def random(self, *args):
        ...
        L = []
        for i in set(args):
            B = self._homogeneous_component(i, minbase=False)
            L.extend([sum([K.random_element() * g for g in B]) for i in range(args.count(i))])
        X = Embedded_projective_variety(self.ambient_space(), L, saturate=False, minbase=False)
    ...
    def empty(self):
        ...
        EXAMPLES::
            ...
            empty subscheme of PP^3
        """
        return (Embedded_projective_variety(self.ambient_space(), [self.ambient_space().coordinate_ring().one()], saturate=False, minbase=False))
    ...
    def random_coordinate_change(self):
        ...
        Y = Embedded_projective_variety(self.ambient_space(), (g._to_ring_map()(self.defining_ideal())).gens(), saturate=False, minbase=False)
    ...
    def intersection(self, other):
        ...
        polys = (self.defining_ideal() + other.defining_ideal()).gens()
        return Embedded_projective_variety(self.ambient_space(), polys, saturate=True, minbase=True)
    ...
    def union(self, other):
        ...
        return Embedded_projective_variety(self.ambient_space(), I.gens(), saturate=False, minbase=True)
    ...
    def __rmul__(self, n):
        r"""
        Returns the closed subscheme of projective space defined by the n-th power
        of the ideal of ``self``, saturated with respect to the irrelevant ideal.
        ...
        EXAMPLES::
            ...
            sage: S = surface(2, KK=GF(65521)); S
            rational surface in PP^5 of degree 4 and sectional genus 0 cut out by 6 hypersurfaces of degree 2 (the image of the plane via the linear system [2])
            sage: 2 * S
            surface in PP^5 of degree 16 and sectional genus 15 cut out by 16 hypersurfaces of degrees (3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4)
        """
        if not isinstance(n,(int,Integer)):
            raise TypeError("expected an integer")
        I = self.defining_ideal() ** n
        return Embedded_projective_variety(ProjectiveSpace(I.ring()), I.gens(), saturate=True, minbase=True)

    def _nodal_projection(self):
        r"""
        Returns the projection of ``self`` from a random point on its secant variety.
        ...
        EXAMPLES::
            ...
            sage: S = surface(4,8, KK=GF(65521)); S
            rational surface in PP^6 of degree 8 and sectional genus 3 cut out by 7 hypersurfaces of degree 2 (the image of the plane via the linear system [4, 8])
            sage: S._nodal_projection()
            surface in PP^5 of degree 8 and sectional genus 3 cut out by 9 hypersurfaces of degrees (2, 3, 3, 3, 3, 3, 3, 3, 3)
        """
        p1 = self.point()
        p2 = self.point()
        p = p1.union(p2).linear_span().point()
        f = rational_map(p)
        return f(self)

    def _count_nodal_projection_nodes(self):
        r"""
        Returns the number of nodes acquired via successive nodal projections leading to the construction of ``self``.

        This method is experimental and assumes that the variety was obtained through generic nodal projections.
        It is internally used in the computation of the discriminant of Hodge-special fourfolds.

        EXAMPLES::

            sage: from sage.schemes.hodge_special_fourfolds.sff import Veronese
            sage: C = Veronese(1,5, KK=GF(65521)); C
            curve of degree 5 and arithmetic genus 0 in PP^5 cut out by 10 hypersurfaces of degree 2
            sage: D = C._nodal_projection()._nodal_projection(); D
            curve of degree 5 and arithmetic genus 2 in PP^3 cut out by 3 hypersurfaces of degrees (2, 3, 3)
            sage: D._count_nodal_projection_nodes()
            2
        """
        if hasattr(self,"_finite_number_of_nodes"):
            return self._finite_number_of_nodes
        if self.linear_span().dimension() < 2 * self.dimension() + 1:
            raise NotImplementedError("expected variety with sufficiently large linear span")
        Y = self.singular_locus().topological_support()
        if Y.dimension() > 0:
            raise RuntimeError("variety must have finitely many nodes")
        self._finite_number_of_nodes = Y.degree()
        return self._finite_number_of_nodes
    ...
    def cone_of_lines(self, point=None):
        ...
        V = Embedded_projective_variety(self.ambient_space(), (g._to_ring_map()(ideal(Z))).gens(), saturate=False, minbase=True)
...
def _check_type_embedded_projective_variety(X):
    ...
    if isinstance(X,Embedded_projective_variety):
        return X
    return Embedded_projective_variety(X, saturate=False, minbase=False)
...
def projective_variety(I, PP=None):
    ...
    if _is_embedded_projective_variety(I):
        if not (PP is None or PP.ambient_space() is PP):
            raise ValueError("invalid projective ambient space: expected PP such that PP.ambient_space() is PP")
        return _check_type_embedded_projective_variety(I)
    if isinstance(I,(tuple,list)):
        if PP is None:
            PP = ProjectiveSpace(ideal(I).ring())
        return Embedded_projective_variety(PP, I, saturate=True, minbase=True)
    if isinstance(I,MPolynomialIdeal):
        if PP is None:
            PP = ProjectiveSpace(I.ring())
        return Embedded_projective_variety(PP, I.gens(), saturate=True, minbase=True)
    raise TypeError
...
class Rational_map_between_embedded_projective_varieties(SchemeMorphism_polynomial_projective_space_field):
    ...
    def __init__(self, X, Y, polys) -> None:
        ...
        if Y is None:
            if len(polys) > 0:
                ...
                Y = Embedded_projective_variety(Y,[Y.coordinate_ring().one()], saturate=False, minbase=False)
    ...
    def image(self, algorithm=None):
        ...
        try:
            ...
            if algorithm == "built-in_kernel_ring_map":
                self._closure_of_image = Embedded_projective_variety(self.target().ambient_space(), (self.super()._to_ring_map().kernel()).gens(), saturate=False, minbase=True)
            else:
                ...
                self._closure_of_image = Embedded_projective_variety(self.target().ambient_space(), (I_sat_elim.subs(t)).gens(), saturate=False, minbase=True)
    ...
    def inverse_image(self, Z, minbase=True):
        r"""
        ...
        return Embedded_projective_variety(self.source().ambient_space(), F.gens(), saturate=False, minbase=minbase)
    ...
    def _0th_projective_degree(self):
        ...
        F = self.inverse_image(L, minbase=False)
    ...
    def base_locus(self, verbose=None, algorithm='macaulay2'):
        ...
        try:
            ...
            I = _saturation(I + self.source().defining_ideal())
            self._base_locus = Embedded_projective_variety(self.source().ambient_space(), I.gens(), saturate=False, minbase=True)
            return self._base_locus
...
def rational_map(*args, **kwargs):
    ...
    if len(args) == 3 and (args[0] is None or _is_embedded_projective_variety(args[0])) and (args[1] is None or _is_embedded_projective_variety(args[1])) and isinstance(args[2],(tuple,list)):
        ...
        X = projective_variety(args[0]) if args[0] is not None else ProjectiveSpace(ideal(polys).ring())
...
class Hodge_special_fourfold(Embedded_projective_variety):
    ...
    def _lattice_intersection_matrix(self, verbose=None):
        r"""
        Return the matrix from which we compute the discriminant of ``self``.
        ...
        TESTS::
            ...
            sage: p1 = P.point()
            sage: p2 = P.point()
            sage: L = p1.union(p2).linear_span(); L
            line in PP^5
            sage: Q1 = L.random(2,1,1); Q1
            quadric surface in PP^5
            sage: Q2 = L.random(2,1,1)
            sage: S = Q1 + Q2; S
            surface in PP^5 of degree 4 and sectional genus 0 cut out by 6 hypersurfaces of degree 2
            sage: X = fourfold(S)
            sage: X.discriminant(verbose=True)
            14
            sage: S.singular_locus()
            curve of degree 1 and arithmetic genus 0 in PP^5 cut out by 30 hypersurfaces of degrees (2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3)
            sage: X = fourfold(S)
            sage: X.discriminant(verbose=False)
            14
        """
        try:
            ...
            KS2 = 12*chiOS-c2TS
            if hasattr(S, "_singular_locus"):
                if verbose:
                    print("computing number of nodes...")
                try:
                    S._count_nodal_projection_nodes()
                except Exception as err:
                    if verbose:
                        print(f"failed to get number of nodes: {err}")
    ...
    def discriminant(self, verbose=None):
        r"""
        Return the discriminant of the Hodge special fourfold.

        OUTPUT:

        An integer, the discriminant of ``self``.

        This invariant is computed from a lattice associated to the fourfold ``self``.
        In most cases (e.g., complete intersection fourfolds), the lattice is of rank 2
        and is generated by the cohomology classes ``[H^2]`` and ``[S]``, where ``H``
        is the class of a hyperplane section of ``self`` and ``S`` is the special surface
        contained in ``self`` (accessible via the method :meth:`surface`). The discriminant
        is then defined as the determinant of the intersection matrix of this lattice.

        For Gushel-Mukai fourfolds, the lattice is constructed differently, using two classes
        coming from the Grassmannian ``G(1,4)`` together with the class of the special surface.
        Currently, in this case the computation requires Macaulay2.

        For theoretical background, see Hassett's papers on special cubic fourfolds.
        See also: https://www.tandfonline.com/doi/abs/10.1080/10586458.2023.2184882

        EXAMPLES::

            sage: X = fourfold(surface(3,4)); X
            ...
            sage: Y = fourfold(surface(5,7,0,1)); Y
...
class _Cubic_fourfold(Hodge_special_fourfold):
    ...
    EXAMPLES::
        ...
        sage: # optional - sage
        sage: from sage.schemes.hodge_special_fourfolds.sff import projective_variety, rational_map
        sage: S = surface(10,0,0,10, KK=GF(33331)); S
        rational surface in PP^5 of degree 10 and sectional genus 6 cut out by 10 hypersurfaces of degree 3 (the image of the plane via the linear system [10, 0, 0, 10])
        sage: X = fourfold(S); X
        Cubic fourfold of discriminant 38 = 3*46-10^2 containing a rational surface in PP^5 of degree 10 and sectional genus 6 cut out by 10 hypersurfaces of degree 3 (the image of the plane via the linear system [10, 0, 0, 10])
        sage: f = rational_map(2 * S, 5); f
        rational map defined by forms of degree 5
        source: PP^5
        target: PP^4
        sage: B = projective_variety(f.defining_polynomials()); B
        3-dimensional variety of degree 6 in PP^5 cut out by 5 hypersurfaces of degree 5
        sage: V = B - S; V
        3-dimensional variety of degree 6 in PP^5 cut out by 12 hypersurfaces of degree 5
        sage: T = V.intersection(X) - S; T
        surface in PP^5 of degree 8 and sectional genus 0 cut out by 10 hypersurfaces of degree 3
        sage: Y = fourfold(T)
        sage: Y.discriminant(verbose=True)
        2
        sage: T.singular_locus()
        0-dimensional subscheme of degree 30 in PP^5
        sage: Y = fourfold(T)
        sage: Y.discriminant(verbose=True)
        computing number of nodes...
        38
        sage: Y
        Cubic fourfold of discriminant 38 = 3*34-8^2 containing a surface in PP^5 of degree 8 and sectional genus 0 cut out by 10 hypersurfaces of degree 3
    """
    def __init__(self, S, X, V=None, check=True):
...
def _saturation(I):
    r"""Compute the saturation of the ideal with respect to the irrelevant ideal."""
    J = I.ring().irrelevant_ideal()
...
def _from_macaulay2_to_sage(X, Sage_Ambient_Space):
    ...
    try:
        ...
        if X.instance('EmbeddedProjectiveVariety').sage():
            ...
            X._sage_object = Embedded_projective_variety(Sage_Ambient_Space, polys, saturate=False, minbase=False)
            X._sage_object._macaulay2_object = X
            return X._sage_object
        raise NotImplementedError
