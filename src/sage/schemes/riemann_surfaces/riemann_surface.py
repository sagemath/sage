...
class RiemannSurface:
    ...
    def is_hyperelliptic(self):
        ...
        We consider the three examples given in ::
        ...
        . It finds the rank of the subspace of quadratic differentials
        generated by holomorphic differentials: if this rank is `\leq 2g-1`, 
