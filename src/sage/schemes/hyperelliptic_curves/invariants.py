...
def ubs(f):
    ...
    EXAMPLES::
        ...
        sage: R.<t> = GF(31)[]                                                          # needs sage.rings.finite_rings
...
def clebsch_to_igusa(A, B, C, D):
    ...
    EXAMPLES::
        ...
        (8, 10, 15, 26)
        sage: igusa_to_clebsch(*clebsch_to_igusa(*Cs))                                  # needs sage.rings.finite_rings
        (2, 3, 4, 5)
    """
    I2 = -120*A
    I4 = -720*A**2 + 6750*B
...
def igusa_to_clebsch(I2, I4, I6, I10):
    ...
    EXAMPLES::
        ...
        (18, 7, 12, 27)
        sage: igusa_to_clebsch(*Is)                                                     # needs sage.rings.finite_rings
        (20, 25, 25, 12)
...
def igusa_clebsch_invariants(f):
    ...
    Let's check a symbolic example::
        ...
        sage: absolute_igusa_invariants_wamelen(GF(5)['x'](x^6 - 2*x))                  # needs sage.rings.finite_rings
...
def absolute_igusa_invariants_wamelen(f):
    ...
    TESTS::
        ...
        sage: absolute_igusa_invariants_wamelen(GF(3)['x'](x^5 - 2*x))                  # needs sage.rings.finite_rings
        Traceback (most recent call last):
        ...
        NotImplementedError: Invariants of binary sextics/genus 2 hyperelliptic curves
        not implemented in characteristics 2, 3, and 5
...
def absolute_igusa_invariants_kohel(f):
    ...
    TESTS::
        ...
        sage: absolute_igusa_invariants_kohel(GF(2)['x'](x^5 - x))                      # needs sage.rings.finite_rings
        Traceback (most recent call last):
        ...
        NotImplementedError: Invariants of binary sextics/genus 2 hyperelliptic curves
        not implemented in characteristics 2, 3, and 5
