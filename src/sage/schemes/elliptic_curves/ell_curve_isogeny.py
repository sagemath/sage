...
the following example::
    ...
    sage: phi = E.isogeny(Q)                                                            # needs sage.rings.finite_rings
...
def _isogeny_determine_algorithm(E, kernel):
    ...
    This helper function will be implicitly called by the following examples::
        ...
        sage: R.<x> = GF(5)[]                                                           # needs sage.rings.finite_rings
    ...
    We can construct the same isogeny from a kernel polynomial::
        ...
        sage: phi = EllipticCurveIsogeny(E, x + 3)  # indirect doctest                  # needs sage.rings.finite_rings

    or from a list of coefficients of a kernel polynomial::

        sage: phi == EllipticCurveIsogeny(E, [3,1])  # indirect doctest                 # needs sage.rings.finite_rings
        True

    or from a rational point which generates the kernel::

        sage: phi == EllipticCurveIsogeny(E, E((2,0)))  # indirect doctest              # needs sage.rings.finite_rings
        True
    ...
    the third case it is Vélu::
        ...
        sage: _isogeny_determine_algorithm(E, x + 3)                                    # needs sage.rings.finite_rings
        'kohel'
        sage: _isogeny_determine_algorithm(E, [3, 1])                                   # needs sage.rings.finite_rings
        'kohel'
        sage: _isogeny_determine_algorithm(E, E((2,0)))                                 # needs sage.rings.finite_rings
        'velu'
    """
...
def compute_codomain_formula(E, v, w):
    ...
    :class:`EllipticCurveIsogeny` constructor::
        ...
        sage: E = EllipticCurve(GF(19), [1,2,3,4,5])                                    # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, E((1,2)) )                                  # needs sage.rings.finite_rings
        sage: phi.codomain()                                                            # needs sage.rings.finite_rings
...
def compute_vw_kohel_even_deg1(x0, y0, a1, a2, a4):
    ...
    This function will be implicitly called by the following example::
        ...
        sage: E = EllipticCurve(GF(19), [1,2,3,4,5])                                    # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, [9,1]); phi                                 # needs sage.rings.finite_rings
        Isogeny of degree 2
...
def compute_vw_kohel_even_deg3(b2, b4, s1, s2, s3):
    ...
    This function will be implicitly called by the following example::
        ...
        sage: E = EllipticCurve(GF(19), [1,2,3,4,5])                                    # needs sage.rings.finite_rings
        sage: R.<x> = GF(19)[]                                                          # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, x^3 + 7*x^2 + 15*x + 12); phi               # needs sage.rings.finite_rings
        Isogeny of degree 4
         from Elliptic Curve defined by y^2 + x*y + 3*y = x^3 + 2*x^2 + 4*x + 5
              over Finite Field of size 19
        ...
        sage: b2,b4 = E.b2(), E.b4()                                                    # needs sage.rings.finite_rings
        sage: s1, s2, s3 = -7, 15, -12                                                  # needs sage.rings.finite_rings
        sage: compute_vw_kohel_even_deg3(b2, b4, s1, s2, s3)                            # needs sage.rings.finite_rings
        (4, 7)
    """
    temp1 = s1**2 - 2*s2
...
def compute_vw_kohel_odd(b2, b4, b6, s1, s2, s3, n):
    ...
    This function will be implicitly called by the following example::
        ...
        sage: E = EllipticCurve(GF(19), [18,17,16,15,14])                               # needs sage.rings.finite_rings
        sage: R.<x> = GF(19)[]                                                          # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, x^3 + 14*x^2 + 3*x + 11); phi               # needs sage.rings.finite_rings
        Isogeny of degree 7
        ...
        sage: b2,b4,b6 = E.b2(), E.b4(), E.b6()                                         # needs sage.rings.finite_rings
...
def compute_codomain_kohel(E, kernel):
    ...
    EXAMPLES::
        ...
        sage: E = EllipticCurve(GF(19), [1,2,3,4,5])                                    # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, [9,1])                                      # needs sage.rings.finite_rings
        sage: phi.codomain() == isogeny_codomain_from_kernel(E, [9,1])                  # needs sage.rings.finite_rings
        True
        sage: compute_codomain_kohel(E, [9,1])                                          # needs sage.rings.finite_rings
        Elliptic Curve defined by y^2 + x*y + 3*y = x^3 + 2*x^2 + 9*x + 8
         over Finite Field of size 19
        sage: R.<x> = GF(19)[]                                                          # needs sage.rings.finite_rings
        sage: E = EllipticCurve(GF(19), [18,17,16,15,14])                               # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, x^3 + 14*x^2 + 3*x + 11)                    # needs sage.rings.finite_rings
        sage: phi.codomain() == isogeny_codomain_from_kernel(E, x^3 + 14*x^2 + 3*x + 11)            # needs sage.rings.finite_rings
        True
        sage: compute_codomain_kohel(E, x^3 + 14*x^2 + 3*x + 11)                        # needs sage.rings.finite_rings
        Elliptic Curve defined by y^2 + 18*x*y + 16*y = x^3 + 17*x^2 + 18*x + 18
         over Finite Field of size 19
        sage: E = EllipticCurve(GF(19), [1,2,3,4,5])                                    # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, x^3 + 7*x^2 + 15*x + 12)                    # needs sage.rings.finite_rings
        sage: isogeny_codomain_from_kernel(E, x^3 + 7*x^2 + 15*x + 12) == phi.codomain()            # needs sage.rings.finite_rings
        True
        sage: compute_codomain_kohel(E, x^3 + 7*x^2 + 15*x + 12)                        # needs sage.rings.finite_rings
        Elliptic Curve defined by y^2 + x*y + 3*y = x^3 + 2*x^2 + 3*x + 15
         over Finite Field of size 19
...
def two_torsion_part(E, psi):
    ...
    formulas will call this function::
        ...
        sage: E = EllipticCurve(GF(19), [1,2,3,4,5])                                    # needs sage.rings.finite_rings
        sage: R.<x> = GF(19)[]                                                          # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, x + 13)                                     # needs sage.rings.finite_rings
...
class EllipticCurveIsogeny(EllipticCurveHom):
    ...
    characteristic::
        ...
        sage: phi = EllipticCurveIsogeny(E, E((0,0)) ); phi                             # needs sage.rings.finite_rings
        Isogeny of degree 2
    ...
    A more complicated example of a characteristic-2 field::
        ...
        Isogeny of degree 3
         from Elliptic Curve defined by y^2 + y = x^3 + 1
           ...
           to Elliptic Curve defined by y^2 + y = x^3
              over Finite Field in alpha of size 2^4
        sage: phi_ker_poly = phi_v.kernel_polynomial()                                  # needs sage.rings.finite_rings
        ...
        (0 : 1 : 0)
        sage: alpha = E.base_field().gen()                                              # needs sage.rings.finite_rings
        sage: Q = E((0, alpha*(alpha + 1)))                                             # needs sage.rings.finite_rings
        sage: phi_v(Q)                                                                  # needs sage.rings.finite_rings
        (1 : alpha^2 + alpha : 1)
        sage: phi_v(P) == phi_k(P)                                                      # needs sage.rings.finite_rings
        True
        sage: phi_k(P) == phi_v.codomain()(0)                                           # needs sage.rings.finite_rings
        True
    ...
    We can create an isogeny whose kernel equals the full 2-torsion::
        ...
        sage: ker_poly = E.division_polynomial(2)                                       # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, ker_poly); phi                              # needs sage.rings.finite_rings
        Isogeny of degree 4
        ...
        (0 : 1 : 0)
        sage: phi.degree()                                                              # needs sage.rings.finite_rings
        4
    ...
    We can also create trivial isogenies with the trivial kernel::
        ...
        sage: phi_v.degree()                                                            # needs sage.rings.finite_rings
        1
        sage: phi_v.rational_maps()                                                     # needs sage.rings.finite_rings
        (x, y)
        sage: E == phi_v.codomain()                                                     # needs sage.rings.finite_rings
        True
        sage: P = E.random_point()                                                      # needs sage.rings.finite_rings
        sage: phi_v(P) == P                                                             # needs sage.rings.finite_rings
        True
        ...
        Isogeny of degree 1
         from Elliptic Curve defined by y^2 + 23*x*y + 22*y = x^3 + x^2 + 7*x + 18
           ...
           to Elliptic Curve defined by y^2 + 23*x*y + 22*y = x^3 + x^2 + 7*x + 18
              over Finite Field of size 31
        sage: phi_k.degree()                                                            # needs sage.rings.finite_rings
        1
        sage: phi_k.rational_maps()                                                     # needs sage.rings.finite_rings
        (x, y)
    ...
    kernel on a CM-curve::
        ...
        sage: RK.<X> = K[]                                                              # needs sage.rings.number_field
        ...
        sage: phi.codomain() == phi.domain()                                            # needs sage.rings.number_field
        True
    ...
    Domain and codomain tests (see :trac:`12880`)::
        ...
        sage: phi = EllipticCurveIsogeny(E, [17, 1])                                    # needs sage.rings.finite_rings
        sage: phi.domain()                                                              # needs sage.rings.finite_rings
    ...
    Composition tests (see :trac:`16245`, cf. :trac:`34410`)::
        ...
        sage: phi2 = phi * phi; phi2                                                    # needs sage.rings.finite_rings
    ...
    def __init__(self, E, kernel, codomain=None, degree=None, model=None, check=True):
        ...
        EXAMPLES::
            ...
            sage: phi = EllipticCurveIsogeny(E, P); phi                                 # needs sage.rings.finite_rings
            Isogeny of degree 8
    ...
    def _call_(self, P):
        ...
        EXAMPLES::
            ...
            sage: phi = EllipticCurveIsogeny(E, [0,1])                                  # needs sage.rings.finite_rings
            sage: phi(P)                                                                # needs sage.rings.finite_rings
            (4 : -4 : 1)
            sage: phi(-P)                                                               # needs sage.rings.finite_rings
            (4 : 4 : 1)
            ...
            sage: tau = E.isogeny([Q], E)                                               # needs sage.rings.finite_rings
            sage: tau(Q)                                                                # needs sage.rings.finite_rings
            (0 : 1 : 0)
        ...
        Coercion works fine with :meth:`_call_` (added for :trac:`16238`)::
            ...
            sage: K.<th> = NumberField(x^2 + 3)                                         # needs sage.rings.number_field
            sage: E = EllipticCurve(K, [7,0])                                           # needs sage.rings.number_field
            sage: E2 = EllipticCurve(K, [5,0])                                          # needs sage.rings.number_field
        ...
        Check that copying the order over works::
            ...
            sage: E = EllipticCurve(GF(431), [1,0])                                     # needs sage.rings.finite_rings
            sage: P, = E.gens()                                                         # needs sage.rings.finite_rings
            sage: Q = 2^99*P; Q.order()                                                 # needs sage.rings.finite_rings
            27
            sage: phi = E.isogeny(3^99*P)                                               # needs sage.rings.finite_rings
            sage: phi(Q)._order                                                         # needs sage.rings.finite_rings
            27
        """
        if P.is_zero():
    ...
    def __neg__(self):
        ...
        The following examples inherently exercise this function::
            ...
            sage: phi = EllipticCurveIsogeny(E, E((-1,0)) )                             # needs sage.rings.finite_rings
            ...
            sage: phi = EllipticCurveIsogeny(E, f, E)                                   # needs sage.rings.finite_rings
            ...
            sage: R.<x> = GF(17)[]                                                      # needs sage.rings.finite_rings
            sage: f = x+6                                                               # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, f); phi                                 # needs sage.rings.finite_rings
            Isogeny of degree 2
            ...
            sage: phi = EllipticCurveIsogeny(E, x - a)                                  # needs sage.rings.number_field
            sage: phi.rational_maps()                                                   # needs sage.rings.number_field
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: phi = EllipticCurveIsogeny(E, E((0,0)) )                              # needs sage.rings.finite_rings
            sage: phi._repr_()                                                          # needs sage.rings.finite_rings
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: R.<X> = GF(17)[]                                                      # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, X + 11)                                 # needs sage.rings.finite_rings
    ...
    def __clear_cached_values(self):
        ...
        EXAMPLES::
            ...
            sage: F = GF(127); R.<x> = F[]                                              # needs sage.rings.finite_rings
            ...
            sage: phi = EllipticCurveIsogeny(E, f)                                      # needs sage.rings.finite_rings
            sage: old_ratl_maps = phi.rational_maps()                                   # needs sage.rings.finite_rings
    ...
    def __perform_inheritance_housekeeping(self):
        ...
        function::
            ...
            sage: R.<x> = GF(43)[]; f = x + 42                                          # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, f)                                      # needs sage.rings.finite_rings
            sage: phi._EllipticCurveIsogeny__perform_inheritance_housekeeping()         # needs sage.rings.finite_rings
            sage: from sage.schemes.elliptic_curves.weierstrass_morphism import WeierstrassIsomorphism
    ...
    def __init_algebraic_structs(self, E):
        ...
        Now, calling the initialization function does nothing more::
            ...
            sage: phi._EllipticCurveIsogeny__init_algebraic_structs(E)                  # needs sage.rings.finite_rings
            sage: phi._domain                                                           # needs sage.rings.finite_rings
            Elliptic Curve defined by y^2 = x^3 + 1 over Finite Field of size 17
            sage: phi._EllipticCurveIsogeny__base_field                                 # needs sage.rings.finite_rings
            Finite Field of size 17
            ...
            sage: F = GF(19); R.<x> = F[]                                               # needs sage.rings.finite_rings
    ...
    def __init_kernel_polynomial(self):
        ...
        The following examples inherently exercise this function::
            ...
            sage: E = EllipticCurve(j=GF(7)(1728))                                      # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, E((0,0)))                               # needs sage.rings.finite_rings
            sage: phi.kernel_polynomial()  # implicit doctest                           # needs sage.rings.finite_rings
            x
        """
    ...
    def __set_pre_isomorphism(self, domain, isomorphism):
        ...
        EXAMPLES::
            ...
            sage: pre_isom = E1pr.isomorphism_to(E)                                                                     # needs sage.rings.finite_rings
            sage: phi._set_pre_isomorphism(pre_isom)                                                                    # needs sage.rings.finite_rings
            sage: phi._EllipticCurveIsogeny__set_pre_isomorphism(E, WeierstrassIsomorphism(E, (-1, 3, -3, 4)))          # needs sage.rings.finite_rings
            sage: E == phi.domain()                                                                                     # needs sage.rings.finite_rings
            True
        """
        self._domain = domain
    ...
    def __setup_post_isomorphism(self, codomain, model):
        ...
        The following examples inherently exercise this function::
            ...
            sage: E = EllipticCurve(j=GF(7)(1728))                                      # needs sage.rings.finite_rings
            sage: E2 = EllipticCurve(GF(7), [0,0,0,5,0])                                # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, E((0,0)), E2); phi                      # needs sage.rings.finite_rings
            Isogeny of degree 2
             from Elliptic Curve defined by y^2 = x^3 + x over Finite Field of size 7
            ...
            sage: phi._EllipticCurveIsogeny__setup_post_isomorphism(E3, None)           # needs sage.rings.finite_rings
            sage: phi                                                                   # needs sage.rings.finite_rings
            Isogeny of degree 2
             from Elliptic Curve defined by y^2 = x^3 + x over Finite Field of size 7
    ...
    def __init_from_kernel_list(self, kernel_gens):
        ...
        could take a long time. ::
            ...
            sage: p = 12 * next_prime(2^180) * next_prime(2^194) - 1                    # needs sage.rings.finite_rings
    ...
    def __compute_codomain_via_velu(self):
        ...
        The following example inherently exercises this function::
            ...
            sage: E = EllipticCurve(GF(7), [0,0,0,-1,0])                                # needs sage.rings.finite_rings
            sage: P = E((4,2))                                                          # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, P)                                      # needs sage.rings.finite_rings
            sage: phi.codomain()                                                        # needs sage.rings.finite_rings
    ...
    def __velu_sum_helper(xQ, Qvalues, a1, a3, x, y):
        ...
        The following example inherently exercises this function::
            ...
            sage: P = E((4,2))                                                          # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, P)                                      # needs sage.rings.finite_rings
            sage: Q = E((0,0)); phi(Q)                                                  # needs sage.rings.finite_rings
            (0 : 0 : 1)
            sage: phi.rational_maps()                                                   # needs sage.rings.finite_rings
            ...
            sage: phi._EllipticCurveIsogeny__velu_sum_helper(0, Qvals, 0, 0, F(5), F(5))            # needs sage.rings.finite_rings
            (3, 3)
            sage: R.<x,y> = GF(7)[]                                                     # needs sage.rings.finite_rings
            sage: phi._EllipticCurveIsogeny__velu_sum_helper(0, Qvals, 0, 0, x, y)      # needs sage.rings.finite_rings
            (1/x, y/x^2)
        """
    ...
    def __compute_via_velu_numeric(self, xP, yP):
        ...
        The following example inherently exercises this function::
            ...
            sage: Q = E((0,0)); phi(Q)                                                  # needs sage.rings.finite_rings
            (0 : 0 : 1)
            sage: Q = E((-1,0)); phi(Q)                                                 # needs sage.rings.finite_rings
            (0 : 0 : 1)
    ...
    def __compute_via_velu(self, xP, yP):
        ...
        The following example inherently exercises this function::
            ...
            (0, 0)
            sage: R.<x,y> = GF(7)[]                                                     # needs sage.rings.finite_rings
            sage: phi._EllipticCurveIsogeny__compute_via_velu(x, y)                     # needs sage.rings.finite_rings
        ...
        Check for :trac:`33214`::
            ...
            sage: P = phi.domain()(1, 46*z2+49)                                         # needs sage.rings.finite_rings
        ...
        that they are plausible (this failed prior to :trac:`33214`)::
            ...
            sage: R.<x,y> = GF(71^2)[]                                                  # needs sage.rings.finite_rings
            sage: E0, E2 = phi.domain(), phi.codomain()                                 # needs sage.rings.finite_rings
            sage: eqs = [EE.defining_polynomial()(x,y,1) for EE in (E0,E2)]             # needs sage.rings.finite_rings
    ...
    def __initialize_rational_maps_via_velu(self):
        ...
        The following example inherently exercises this function::
            ...
            sage: phi.rational_maps()                                                   # needs sage.rings.finite_rings
            ((x^4 - 2*x^3 + x^2 - 3*x)/(x^3 - 2*x^2 + 3*x - 2), (x^5*y - 2*x^3*y - x^2*y - 2*x*y + 2*y)/(x^5 + 3*x^3 + 3*x^2 + x - 1))
            sage: phi._EllipticCurveIsogeny__initialize_rational_maps_via_velu()        # needs sage.rings.finite_rings
    ...
    def __init_from_kernel_polynomial(self, kernel_polynomial):
        ...
        These examples inherently exercise this private function::
            ...
            sage: phi._EllipticCurveIsogeny__init_from_kernel_polynomial(x)             # needs sage.rings.finite_rings
    ...
    def __init_odd_kernel_polynomial(self, E, psi):
        ...
        These examples inherently exercise this private function::
            ...
            sage: F = GF(2^4, 'alpha'); R.<x> = F[]                                     # needs sage.rings.finite_rings
            sage: alpha = F.gen()                                                       # needs sage.rings.finite_rings
    ...
    def __compute_omega_fast(self, E, psi, psi_pr, phi, phi_pr):
        ...
        These examples inherently exercise this private function::
            ...
            sage: phi._EllipticCurveIsogeny__compute_omega_fast(E, psi, psi_pr, fi, fi_pr)          # needs sage.rings.finite_rings
            (x^3 + 4*x^2 + x)*y
        """
        a1 = E.a1()
        a3 = E.a3()
    ...
    def __compute_omega_general(self, E, psi, psi_pr, phi, phi_pr):
        ...
        These examples inherently exercise this private function::
            ...
            sage: fi = phi._EllipticCurveIsogeny__phi                                   # needs sage.rings.finite_rings
            sage: fi_pr = fi.derivative()                                               # needs sage.rings.finite_rings
            sage: phi._EllipticCurveIsogeny__compute_omega_general(E, psi, psi_pr, fi, fi_pr)       # needs sage.rings.finite_rings
        ...
        A bug fixed in :trac:`7907`::
            ...
            sage: ker = (x^6 + (a^6 + a^5 + a^4 + a^3 + a^2 + a)*x^5 + (a^6 + a^5 + a^2 + 1)*x^4    # needs sage.rings.finite_rings
    ...
    def __compute_via_kohel_numeric(self, xP, yP):
        ...
        These examples inherently exercise this private function::
            ...
            sage: R.<x> = GF(7)[]                                                       # needs sage.rings.finite_rings
            sage: E = EllipticCurve(GF(7), [0,-1,0,0,1])                                # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, x+6, degree=3)                          # needs sage.rings.finite_rings
    ...
    def __compute_via_kohel(self, xP, yP):
        ...
        These examples inherently exercise this private function::
            ...
            sage: phi._EllipticCurveIsogeny__compute_via_kohel(0,1)                     # needs sage.rings.finite_rings
            (2, 0)
            sage: R.<x,y> = GF(7)[]                                                     # needs sage.rings.finite_rings
            sage: phi._EllipticCurveIsogeny__compute_via_kohel(x,y)                     # needs sage.rings.finite_rings
            ((x^3 - 2*x^2 + 3*x + 2)/(x^2 - 2*x + 1), (x^3*y - 3*x^2*y + x*y)/(x^3 - 3*x^2 + 3*x - 1))
        """
        a = self.__phi(xP)
    ...
    def __initialize_rational_maps_via_kohel(self):
        ...
        These examples inherently exercise this private function::
            ...
            sage: phi.rational_maps()                                                   # needs sage.rings.finite_rings
            ((x^3 - 2*x^2 + 3*x + 2)/(x^2 - 2*x + 1), (x^3*y - 3*x^2*y + x*y)/(x^3 - 3*x^2 + 3*x - 1))
            sage: phi._EllipticCurveIsogeny__initialize_rational_maps_via_kohel()       # needs sage.rings.finite_rings
    ...
    def scaling_factor(self):
        ...
        EXAMPLES::
            ...
            1
            sage: phi.dual().scaling_factor()                                           # needs sage.rings.finite_rings
            43
    ...
    def kernel_polynomial(self):
        ...
        EXAMPLES::
            ...
            sage: phi = EllipticCurveIsogeny(E, [1])                                    # needs sage.rings.finite_rings
            sage: phi.kernel_polynomial()                                               # needs sage.rings.finite_rings
            1

            sage: E = EllipticCurve(GF(31), [0,0,0,3,0])                                # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, [0,3,0,1])                              # needs sage.rings.finite_rings
            sage: phi.kernel_polynomial()                                               # needs sage.rings.finite_rings
            x^3 + 3*x
        """
        if self.__kernel_polynomial is None:
    ...
    def _set_pre_isomorphism(self, preWI):
        ...
        TESTS::
            ...
            sage: R.<x> = GF(31)[]                                                      # needs sage.rings.finite_rings
            sage: f = x^3 + 9*x^2 + x + 30                                              # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, f)                                      # needs sage.rings.finite_rings
            sage: Epr = E.short_weierstrass_model()                                     # needs sage.rings.finite_rings
            sage: isom = Epr.isomorphism_to(E)                                          # needs sage.rings.finite_rings
            ...
            sage: R.<x> = GF(29)[]                                                      # needs sage.rings.finite_rings
    ...
    def _set_post_isomorphism(self, postWI):
        ...
        TESTS::
            ...
            sage: R.<x> = GF(31)[]                                                      # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, x+18)                                   # needs sage.rings.finite_rings
            sage: from sage.schemes.elliptic_curves.weierstrass_morphism import WeierstrassIsomorphism
            ...
            sage: phi = EllipticCurveIsogeny(E, f)                                      # needs sage.rings.finite_rings
            sage: E2 = phi.codomain()                                                   # needs sage.rings.finite_rings
            sage: post_isom = E2.isomorphism_to(E)                                      # needs sage.rings.finite_rings
            sage: phi._set_post_isomorphism(post_isom)                                  # needs sage.rings.finite_rings
            sage: phi.rational_maps() == E.multiplication_by_m(3)                       # needs sage.rings.finite_rings
            False
    ...
    def dual(self):
        ...
        EXAMPLES::
            ...
            sage: E = EllipticCurve(GF(37), [0,0,0,1,8])                                # needs sage.rings.finite_rings
            sage: R.<x> = GF(37)[]                                                      # needs sage.rings.finite_rings
            sage: f = x^3 + x^2 + 28*x + 33                                             # needs sage.rings.finite_rings
            sage: phi = EllipticCurveIsogeny(E, f)                                      # needs sage.rings.finite_rings
            sage: phi_hat = phi.dual()                                                  # needs sage.rings.finite_rings
            sage: phi_hat.codomain() == phi.domain()                                    # needs sage.rings.finite_rings
            True
            sage: phi_hat.domain() == phi.codomain()                                    # needs sage.rings.finite_rings
            True
            ...
            sage: Xm = Xhat.subs(x=X, y=Y)                                              # needs sage.rings.finite_rings
            sage: Ym = Yhat.subs(x=X, y=Y)                                              # needs sage.rings.finite_rings
            sage: (Xm, Ym) == E.multiplication_by_m(7)                                  # needs sage.rings.finite_rings
            True

            sage: E = EllipticCurve(GF(31), [0,0,0,1,8])                                # needs sage.rings.finite_rings
            sage: R.<x> = GF(31)[]                                                      # needs sage.rings.finite_rings
        ...
        Inseparable duals should be computed correctly::
            ...
            sage: E.isogeny(3*E.lift_x(0)).dual()                                       # needs sage.rings.finite_rings
            Composite morphism of degree 71 = 71*1^2:
              ...
              To:   Elliptic Curve defined by y^2 = x^3 + (41*z2+56)*x + (18*z2+42)
                    over Finite Field in z2 of size 71^2
            sage: E.isogeny(E.lift_x(0)).dual()                                         # needs sage.rings.finite_rings
        ...
        ...even if pre- or post-isomorphisms are present::
            ...
            sage: from sage.schemes.elliptic_curves.weierstrass_morphism import WeierstrassIsomorphism
            sage: phi = E.isogeny(E.lift_x(0))                                          # needs sage.rings.finite_rings
            sage: pre = ~WeierstrassIsomorphism(phi.domain(), (z2,2,3,4))               # needs sage.rings.finite_rings
            sage: post = WeierstrassIsomorphism(phi.codomain(), (5,6,7,8))              # needs sage.rings.finite_rings
        ...
        Check that :trac:`17293` is fixed::
            ...
            sage: k.<s> = QuadraticField(2)                                             # needs sage.rings.number_field
...
#            assert phi_hat.scaling_factor() == 1
    ...
    def _composition_impl(left, right):
        ...
        EXAMPLES::
            ...
            sage: iso2 = E2.isomorphism_to(E2.change_weierstrass_model(39,0,0,0))       # needs sage.rings.finite_rings
...
def compute_isogeny_stark(E1, E2, ell):
    ...
    EXAMPLES::
        ...
        sage: R.<x> = GF(97)[]; f = x^5 + 27*x^4 + 61*x^3 + 58*x^2 + 28*x + 21          # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, f)                                          # needs sage.rings.finite_rings
        sage: E2 = phi.codomain()                                                       # needs sage.rings.finite_rings
        sage: isom1, isom2, E1pr, E2pr, ker_poly = compute_sequence_of_maps(E, E2, 11)  # needs sage.rings.finite_rings
...
def split_kernel_polynomial(poly):
    ...
    Check that this behaves identically to ``.radical()``::
        ...
        sage: R = GF(q^e,'a')['x']                                                      # needs sage.rings.finite_rings
        sage: f = R.random_element(randrange(10,100)).monic()                           # needs sage.rings.finite_rings
        sage: split_kernel_polynomial(f) == f.radical()                                 # needs sage.rings.finite_rings
        doctest:warning ...
        DeprecationWarning: ...
        True
    """
...
def compute_isogeny_kernel_polynomial(E1, E2, ell, algorithm="stark"):
    ...
    Check that :meth:`Polynomial.radical` is doing the right thing for us::
        ...
        sage: ker_poly = compute_isogeny_stark(E, E2, 7); ker_poly                      # needs sage.rings.finite_rings
        x^6 + 2*x^5 + 20*x^4 + 11*x^3 + 36*x^2 + 35*x + 16
        sage: ker_poly.factor()                                                         # needs sage.rings.finite_rings
...
def compute_intermediate_curves(E1, E2):
    ...
    EXAMPLES::
        ...
        sage: R.<x> = GF(83)[]; f = x + 24                                              # needs sage.rings.finite_rings
        sage: phi = EllipticCurveIsogeny(E, f)                                          # needs sage.rings.finite_rings
        sage: E2 = phi.codomain()                                                       # needs sage.rings.finite_rings
