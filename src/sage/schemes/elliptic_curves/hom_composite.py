...
class EllipticCurveHom_composite(EllipticCurveHom):
    ...
    def rational_maps(self):
        ...
        EXAMPLES::
            ...
            ((x^9 + 27463*x^8 + 21204*x^7 - 5750*x^6 + 1610*x^5 + 14440*x^4 + 26605*x^3
              - 15569*x^2 - 3341*x + 1267)/(x^8 + 27463*x^7 + 26871*x^6 + 5999*x^5
              - 20194*x^4 - 6310*x^3 + 24366*x^2 - 20905*x - 13867),
