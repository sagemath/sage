...
autosummary_mock_imports = [
    ...
    "cvxpy",
    "pyscipopt",
    "sage.repl.ipython_kernel", # side effects
    "sage.libs.gap.all_documented_functions", # side effects
    "pycryptosat",
    "sage.tests.gosper",
    "sage.tests.symbolic",
    "sage.tests.article_heuberger_krenn_kropf_fsm",
    "sage.tests.books.computational",
    "sage.tests.books.judson",
    "valgrind",
    "sage.numerical.backends.cvxpy_backend_test",
    "sage.numerical.backends.scip_backend_test",
    "pycosat"
]
...
templates_path = ['common/templates-furo']
...
templates_path = [
    '../common/templates-furo',
    os.path.normpath(os.path.join(os.path.dirname(__file__), '../../../../src/doc/common/templates-furo')),
]
...
html_common_static_path = '../common/static'
