...
import sage.env
sage.env.default_required_modules = sage.env.default_optional_modules = ('fflas-ffpack', 'givaro', 'gsl', 'linbox', 'cblas',
...
sage_build_cython.built_distributions = ['sagemath-linbox']
...
python_packages, python_modules, cython_modules = find_python_sources(
    '.', ['sage'], distributions=['sagemath-linbox'])
extra_files = find_extra_files(
    '.', ['sage'], '/doesnotexist', distributions=['sagemath-linbox'])
package_data = {"": [f
