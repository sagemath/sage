...
import sage.env
sage.env.default_required_modules = sage.env.default_optional_modules = ('gsl', 'Singular', 'ecl')
...
if sdist:
    ...
    python_packages, python_modules, cython_modules = find_python_sources(
        '.', ['sage'], distributions=['sagemath-symbolics'])
    extra_files = find_extra_files(
        '.', ['sage'], '/doesnotexist', distributions=['sagemath-symbolics'])
    package_data = {"": [f
