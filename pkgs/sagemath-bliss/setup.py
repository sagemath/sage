...
logger.warn('python_packages = {0}'.format(python_packages))
logger.warn('python_modules = {0}'.format(python_modules))
logger.warn('cython_modules = {0}'.format(cython_modules))
