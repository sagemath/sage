...
# the generation of the files generated in 'src/doc' by 'src/doc/bootstrap.py'.
...
configure: bootstrap src/doc/bootstrap.py $(CONFIGURE_DEPENDENCIES) $(SPKG_INFO_DEPENDENCIES)
	./bootstrap -d
