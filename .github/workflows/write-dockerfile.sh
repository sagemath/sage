...
echo "# Automatically generated by write-dockerfile.sh"
...
$ADD src/doc/bootstrap.py /new/src/doc/bootstrap.py
...
RUN cd /new && rm -rf .git && \\
    if /.github/workflows/retrofit-worktree.sh worktree-pre /sage; then \\
